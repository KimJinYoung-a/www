			...
			<div class="cultureContent cultureEvt">
				...
				<div class="content">
					...
					<div class="cmt-group-barV19 cmt-group-barV19a">
						<div style="background:<%=oevent.FOneItem.fnEventBarColorCode%>;" class="inner"> <!-- for dev msg : 테마색상 등록 -->
							...
							<p class="date">
								...
								<span><strong>당첨자 발표 :</strong> <%=formatdate(oevent.FOneItem.fcomm_end,"0000.00.00")%></span>
							</p>
						</div>
					</div>
                    <% end if %>
                    ...
                    <div class="basicCmtWrap tMar50" id="cmt">
						<iframe id="evt_cmt" src="/event/lib/iframe_comment.asp?eventid=<%=evt_code%>&epdate=<%=oevent.FOneItem.fcomm_end%>" width="100%" class="autoheight"  frameborder="0" scrolling="no"></iframe>
