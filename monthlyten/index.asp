...
<body>
	...
	<script type="text/javascript" src="/vue/monthlyten202301/js_applyItemInfo.js?v=1.01"></script>
	...
	<script src="/vue/monthlyten202301/rabbit_item.js?v=1.00"></script>
	<script src="/vue/monthlyten202301/benefit.js?v=1.03"></script>
	<script src="/vue/monthlyten202301/saleItem.js?v=1.00"></script>
    <script src="/vue/monthlyten202301/event_list.js?v=1.00"></script>

	<script src="/vue/monthlyten202301/store.js?v=1.00"></script>
