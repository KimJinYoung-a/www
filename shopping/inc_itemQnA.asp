...
<div class="section qnaV15" id="detail04">
	<div class="sorting">
		<h3>Q&amp;A <span class="fn fs11">(<strong><%=formatNumber(oQna.FTotalCount,0)%></strong>)</span></h3>
		<div class="option">
			<a href="" onclick="return false;" id="inquiryBtn" class="btn btnS2 btnRed">상품 문의하기</a>
		</div>
	</div>
	<div id="inquiryForm" class="boardForm tMar05">
		<form name="qnaform" method="post" action="<%=wwwUrl%>/my10x10/doitemqna.asp" onsubmit="return false;">
