...
<%
	Dim CurrPage , oGround ,  oGroundsub , oGroundsubcnt , i , oGroundTag , oGroundItem , ii , iii , tempi
	...
	set oGround = new CPlayContents
		...
		oGround.fnGetGroundMainList_review() '리스트들
		oGround.GetRowGroundMain_review() 'one view
	...
	set oGroundsub = new CPlayContents
		...
		End If 
		oGroundsub.fnGetGroundSubList_review() 'sublist
	...
	set oGroundsubcnt = new CPlayContents
		...
		oGroundsubcnt.GetRowGroundSub_review() 'oneview
	...
	Set oGroundTag = new CPlayContents
		...
		snpImg = Server.URLEncode(oGround.FOneItem.Flistimg)
					...
					<div class="groundHead">
						...
						<div class="overHidden tPad20 bPad30">
							...
							<ul class="grSubNav">
								...
								<li class="navi0<%=ii+1%> <%=chkiif(ii = 0 And subidx = "" Or( oGroundsubcnt.FOneItem.Fidx = oGroundsub.FItemList(ii).Fidxsub )," current","")%>  " onclick="chgsubground('<%=oGroundsub.FItemList(ii).Fidxsub%>');">
									<div class="inner">
