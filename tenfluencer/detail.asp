...
<%
    ...
    SET oMedia = new MediaCls
		...
		strHeaderAddMetaTag = "<meta property=""og:title"" content=""[텐바이텐/텐플루언서] "& replace(oMedia.FOneItem.Fctitle,"""","") &""" />" & vbCrLf &_
							"<meta property=""og:type"" content=""website"" />" & vbCrLf &_
							"<meta property=""og:url"" content=""http://www.10x10.co.kr/tenfluencer/detail.asp?cidx=" & vContentsidx & """ />" & vbCrLf
		...
		strHeaderAddMetaTag = strHeaderAddMetaTag & "<meta property=""og:image"" content=""" & oMedia.FOneItem.Fmainimage & """ />" & vbCrLf &_
													...
													"<meta property=""og:description"" content=""[텐바이텐/텐플루언서] "& oMedia.FOneItem.Fctext &""">" & vbCrLf
		strPageImage = oMedia.FOneItem.Fmainimage
		strPageDesc = "[텐바이텐/텐플루언서] "& oMedia.FOneItem.Fctext &""
		end If

		strPageTitle = "텐바이텐 10X10 : " & oMedia.FOneItem.Fctitle
		strPageKeyword = "텐플루언서, " & replace(oMedia.FOneItem.Fctitle,"""","")
		'#############################################################################################################################################################
%>
...
<div class="wrap">
	...
	<div class="container">
		<div class="plf-head">
			<h2><a href="/tenfluencer/">tenfluencer</a></h2>
		</div>
		<div class="inner">
			<div class="view-left">
				<div class="owner">
				...
				<%' 이벤트 코멘트 %>
				<!-- #include file="inc_eventcomment.asp" -->
				<%' 이벤트 코멘트 %>
			</div>
            <div class="floating-wrap">
                <%' 연관상품 %>
                <!-- #include file="inc_infoitems.asp" -->
                <%' 연관상품 %>
                <div class="bnr-list">
                    <ul>
            ...
            <%' 추천 컨텐츠 %>
            <!-- #include file="inc_relatedContents.asp" -->
            <%' 추천 컨텐츠 %>
			<%' !-- 박수 30번 축하 레이어 -- %>
			<div class="ly-clap">
