		...
		<div class="headerV18 headerVnew">
			<div class="inner">
				<%
					...
					elseif (Date>="2021-10-07" and Date<="2021-10-31") then
						'20주년
						sTenLogoClass = "style=""width:165px; top:15px; left:-15px; height:60px; background-image:url(//fiximage.10x10.co.kr/web2021/anniv2021/img_ten_anni20.gif?v=2); background-position:50% 50%; background-size: 100%;"""
				...
				<div class="head-service">
					<ul class="nav">
						...
						<% If now()>="2020-10-05" And now() < "2020-10-29" Then %>
							<li class="nav-anniv"><a href="/event/19th/index.asp">9월세일</a></li>
						<% End If %>
						...
						<% If now()>="2019-03-29" And now() < "2019-04-22" Then %>
							<li class="nav-april"><a href="/event/salelife/index.asp?gaparam=main_menu_april">4월세일</a></li>
						<% End If %>
						...
						<% End If %>
						<% If now() >= #06/27/2022 10:00:00# Then %>
						...
						<li class="nav-new"><a href="/shoppingtoday/shoppingchance_newitem.asp?gaparam=main_menu_new" onclick="fnAmplitudeEventMultiPropertiesAction('click_topmenu','type|landing_url','new|<%=Request.ServerVariables("PATH_INFO")%>');">신상품</a></li>
						<li class="nav-best"><a href="/award/awardlist.asp?atype=b&gaparam=main_menu_best" onclick="fnAmplitudeEventMultiPropertiesAction('click_topmenu','type|landing_url','best|<%=Request.ServerVariables("PATH_INFO")%>');">베스트</a></li>
						<li class="nav-sale"><a href="/shoppingtoday/shoppingchance_saleitem.asp?gaparam=main_menu_sale" onclick="fnAmplitudeEventMultiPropertiesAction('click_topmenu','type|landing_url','sale|<%=Request.ServerVariables("PATH_INFO")%>');">할인특가</a></li>
						<li class="nav-event"><a href="/shoppingtoday/shoppingchance_allevent.asp?gaparam=main_menu_event" onclick="fnAmplitudeEventMultiPropertiesAction('click_topmenu','type|landing_url','event|<%=Request.ServerVariables("PATH_INFO")%>');">기획전</a></li>
						<li class="nav-brand"><a href="/street/?gaparam=main_menu_brand" onclick="fnAmplitudeEventMultiPropertiesAction('click_topmenu','type|landing_url','brand|<%=Request.ServerVariables("PATH_INFO")%>');">브랜드</a></li>
					</ul>
