	...
	<% If now() > #07/09/2018 10:00:00# And Now() < #07/16/2018 00:00:00# then %>
		<% 	If request.cookies("appcoupon1060")<>"Y" Then %>
			...
			<div class="front-Bnr-appCouponBanner" style="display:none;">
				<p><a href="/my10x10/couponbook.asp"><img src="http://webimage.10x10.co.kr/eventIMG/2018/mkt/0709/bnr_front.jpg" alt="첫 구매 쿠폰이 발급되었습니다 App Coupon 5000원 24시간 이내 쿠폰함으로 가기" /></a></p>
	...
	<script type="text/javascript">
		...
		<% If IsUserLoginOK Then %>
			<% If Trim(session("appboySession")) <> "" Then %>
				...
				amplitude.getInstance().identify(amplitudeIdentify);
				<%'// 로그인 완료시 Amplitude 이벤트 전송 %>
				fnAmplitudeEventAction("login_complete", "", "");				
