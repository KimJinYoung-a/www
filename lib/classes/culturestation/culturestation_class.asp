...
Class cevent_oneitem
	...
	public Function fnEventBarColorCode
		If fthemecolor="1" Then
			fnEventBarColorCode = "#ed6c6c"
		ElseIf fthemecolor="2" Then
			fnEventBarColorCode = "#f385af"
		ElseIf fthemecolor="3" Then
			fnEventBarColorCode = "#f3a056"
		ElseIf fthemecolor="4" Then
			fnEventBarColorCode = "#e7b93c"
		ElseIf fthemecolor="5" Then
			fnEventBarColorCode = "#8eba4a"
		ElseIf fthemecolor="6" Then
			fnEventBarColorCode = "#43a251"
		ElseIf fthemecolor="7" Then
			fnEventBarColorCode = "#50bdd1"
		ElseIf fthemecolor="8" Then
			fnEventBarColorCode = "#5aa5ea"
		ElseIf fthemecolor="9" Then
			fnEventBarColorCode = "#2672bf"
		ElseIf fthemecolor="10" Then
			fnEventBarColorCode = "#2c5a85"
		ElseIf fthemecolor="11" Then
			fnEventBarColorCode = "#848484"
...
class cevent_list
	...
	public sub fevent_list()
		...
		If frectUserid <> "" Then
		addSql = addSql & " and e.evt_code in (select evt_code from [db_event].[dbo].[tbl_event_comment] where userid='" + Cstr(frectUserid) + "' group by evt_code)" + vbcrlf
		End If
		...
		addSql = addSql & " and getdate() between e.evt_startdate and e.evt_enddate" + vbcrlf
		...
		sqlStr = sqlStr & " LEFT JOIN [db_event].[dbo].[tbl_event_display] as d on d.evt_code=e.evt_code" + vbcrlf
        ...
        sqlStr = sqlStr & " e.evt_code, e.evt_name, e.evt_subcopyK, e.evt_regdate, e.evt_startdate, e.evt_enddate"+ vbcrlf
		sqlStr = sqlStr & ", d.eventtype_pc as evt_type, d.evt_mainimg, d.eventtype_mo as evt_kind"+ vbcrlf
		sqlStr = sqlStr & "	,(select count(c.evtcom_idx) from db_event.dbo.tbl_event_comment as c "+ vbcrlf
		sqlStr = sqlStr & "	where c.evtcom_using='Y' and c.evt_code=e.evt_code) as comCnt "+ vbcrlf
        sqlStr = sqlStr & " From db_event.dbo.tbl_event as e "+ vbcrlf
		sqlStr = sqlStr & " LEFT JOIN [db_event].[dbo].[tbl_event_display] as d on d.evt_code=e.evt_code"+ vbcrlf
        sqlStr = sqlStr & addSql
	...
	public sub fevent_list_more()
        ...
        sqlStr = "Select top " + CStr(FPageSize * FCurrPage)
        sqlStr = sqlStr & " e.evt_code, e.evt_name, e.evt_subcopyK, e.evt_regdate, e.evt_startdate" + vbcrlf
		sqlStr = sqlStr & " , e.evt_enddate, d.eventtype_pc as evt_type, d.evt_mainimg, d.eventtype_mo as evt_kind" + vbcrlf
		sqlStr = sqlStr & "	,(select count(c.evtcom_idx) from db_event.dbo.tbl_event_comment as c " + vbcrlf
		sqlStr = sqlStr & "	where c.evtcom_using='Y' and c.evt_code=e.evt_code) as comCnt " + vbcrlf
        sqlStr = sqlStr & " From db_event.dbo.tbl_event as e " + vbcrlf
		sqlStr = sqlStr & " LEFT JOIN [db_event].[dbo].[tbl_event_display] as d on d.evt_code=e.evt_code" + vbcrlf
    ...
    public Sub fevent_view()
		...
		sqlStr = sqlStr & " d.iscomment as comment, e.evt_code, e.evt_name, e.evt_regdate, e.evt_startdate, e.evt_enddate, e.evt_prizedate, e.evt_using" + vbcrlf
		sqlStr = sqlStr & " ,d.eventtype_pc as evt_type, d.eventtype_mo as evt_kind, d.evt_mainimg, d.evt_html, d.evt_html_mo" + vbcrlf
		sqlStr = sqlStr & ", d.themecolor, d.iscomment, datediff(d,e.evt_enddate,getdate()) as dcount" + vbcrlf
		sqlStr = sqlStr & ", t.comm_isusing, t.comm_text, t.freebie_img, t.comm_start, t.comm_end, e.evt_state" + vbcrlf
		sqlStr = sqlStr & " from db_event.dbo.tbl_event as e" + vbcrlf
		sqlStr = sqlStr & " LEFT JOIN [db_event].[dbo].[tbl_event_display] as d on d.evt_code=e.evt_code"
		sqlStr = sqlStr & " LEFT JOIN [db_event].[dbo].[tbl_event_md_theme] as t on t.evt_code=e.evt_code"
		...
		End IF
			...
			if frectevt_type <> "" then
				sqlStr = sqlStr & " and e.eventtype_pc = "& frectevt_type &"" + vbcrlf		
			end if				
        ...
        if Not rsget.Eof then
			...
			FOneItem.fimage_main = rsget("evt_mainimg")
	...
	public sub fevent_make()
		...
		sqlStr = sqlStr & " a.evt_code, a.evt_name, d.eventtype_pc as evt_type" + vbcrlf
		sqlStr = sqlStr & " from db_event.dbo.tbl_event a" + vbcrlf
		sqlStr = sqlStr & " left join db_event.dbo.tbl_event_display d on a.evt_code=d.evt_code" + vbcrlf
		sqlStr = sqlStr & " where a.evt_using='Y'" + vbcrlf
		sqlStr = sqlStr & " and a.evt_kind=5" + vbcrlf
		sqlStr = sqlStr & " and a.evt_startdate<=(select getdate())" + vbcrlf
		sqlStr = sqlStr & " and a.evt_enddate>=(select getdate())" + vbcrlf
		if frectevt_type <> "" then
