<% if request.ServerVariables("SCRIPT_NAME")="/diarystory2017/search/index.asp" then %>
	<div class="diaryHead">
		<h2><a href="/diarystory2017/"><img src="http://fiximage.10x10.co.kr/web2016/diarystory2017/tit_diary_story.png" alt="DIARY STORY" /></a></h2>
		<p class="tPad15"><img src="http://fiximage.10x10.co.kr/web2016/diarystory2017/txt_width_10x10.png" alt="WRITE YOUR LIFE WITH 10x10" /></p>
		<ul class="diaryNav">
			<li class="special"><a href="/diarystory2017/brandspecial.asp">Brand Special</a></li>
			<li class="event"><a href="/diarystory2017/event.asp">Diary Event</a></li>
			<li class="finder current"><a href="" onclick="return false;">다이어리 찾기</a></li>
		</ul>
	</div>
<% else %>
	<div class="diaryHead">
		...
		<p class="tPad15"><img src="http://fiximage.10x10.co.kr/web2016/diarystory2017/txt_width_10x10.png" alt="WRITE YOUR LIFE WITH 10x10" /></p>
		<ul class="diaryNav">
			<li class="special <% if request.ServerVariables("SCRIPT_NAME")="/diarystory2017/brandspecial.asp" then %>current<% end if %>"><a href="/diarystory2017/brandspecial.asp">Brand Special</a></li>
			<li class="event <% if request.ServerVariables("SCRIPT_NAME")="/diarystory2017/event.asp" then %>current<% end if %>"><a href="/diarystory2017/event.asp">Diary Event</a></li>
			<li class="finder"><a href="#" onclick="viewPoupLayer('modal',$('#lyrDiarySch').html());return false;" target="_top">다이어리 찾기</a></li>
		</ul>
	</div>
	...
	<%
		...
		If GetPolderName(2) = "search" OR CurrURL() = "/diarystory2017/index.asp" OR GetPolderName(2) = "event" OR CurrURL() = "/diarystory2017/diary_prd.asp" Then
			vMenuNum = -1
		End IF
	%>
...
<div id="lyrDiarySch" style="display:none">
	<div class="diarySearch">
		<div class="diarySearchWrap">
			<h3><img src="http://fiximage.10x10.co.kr/web2016/diarystory2017/tit_diary_search.png" alt="나만의 다이어리 찾기" /><strong>원하는 항목에 체크해 주세요. <em class="cRd0V15">중복체크도 가능</em>합니다.</strong></h3>
			<p class="goPlanner"><a href="/event/eventmain.asp?eventid=73328" target="_top">혹시 플래너를 찾으시나요?</a></p>
			<div class="searchOption">
				<dl class="optionType01">
					<dt><img src="http://fiximage.10x10.co.kr/web2016/diarystory2017/tit_design.png" alt="STYLE - 스타일을 선택해 주세요" /></dt>
					<dd>
						<ul class="optionList">
				...
				<dl class="optionType02">
					<dt><img src="http://fiximage.10x10.co.kr/web2016/diarystory2017/tIt_contents.png" alt="CONTENTS - 내부 구성을 선택해 주세요" /></dt>
					<dd>
						<dl class="dateType">
							<dt><img src="http://fiximage.10x10.co.kr/web2016/diarystory2017/txt_date.png" alt="DATE TYPE" /></dt>
							<dd>
								<ul class="optionList">
									<li><input type="checkbox" class="check" id="optCt01" name="contents" value="'only 2017'" /> <label for="optCt01">Only 2017</label></li>
				...
				<dl class="optionType03">
					<dt><img src="http://fiximage.10x10.co.kr/web2016/diarystory2017/tit_cover.png" alt="COVER - 커버 타입을 선택해 주세요" /></dt>
					<dd>
						<dl class="material">
			...
			<div class="searchBtn"><input type="submit" value="검색" onclick="javascript:goSearchDiary();" class="btn btnB1 btnRed" /></div>
