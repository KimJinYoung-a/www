...
mktTest = False
End If
eventStartDate  = cdate("2023-01-27")		'이벤트 시작일
eventEndDate 	= cdate("2023-01-31")		'이벤트 종료일

if mktTest then
currentDate = cdate("2023-01-27")
else
currentDate = date()
end if
...
function eventTry(){
	...
	<% else %>
		...
		$.ajax({
			type:"POST",
			url:"/event/double-mileage/doEventSubscript121872.asp",
			data: data,
			dataType: "JSON",
			success : function(res){
					if(res!="") {
						// console.log(res)
						if(res.response == "ok"){
							alert('신청이 완료되었습니다.\n02월 08일에 마일리지가 지급되면 알림톡이 발송됩니다.');
							return false;
						}else{
							alert(res.faildesc);
							return false;
...
<div class="mEvtDoubleMileage">
  <article class="img-section-01">
    <img src="//webimage.10x10.co.kr/fixevent/event/2023/121872/img-section-01.jpg?var=1.2" alt="더블 마일리지">
    <p class="sub-text"><strong>단 5일간</strong> 포토후기 작성하면 <strong>마일리지 4배 적립!</strong></p>
    <p class="sub-dscrp">이벤트 기간 : 1월 27일 - 31일</p>
  </article>
  <article class="img-section-02">
    <img src="//webimage.10x10.co.kr/fixevent/event/2023/121872/img-section-02.jpg" alt="상품후기 마일리지">
    <p class="sub-dscrp">&#42;추가 혜택 300p는 2월 8일 일괄 지급</p>
  </article>
  <article class="img-section-03">
    <img src="//webimage.10x10.co.kr/fixevent/event/2023/121872/img-section-03.jpg" alt="포토후기 마일리지">
    <p class="sub-dscrp">&#42;추가 혜택 100p는 2월 8일 일괄 지급</p>
  </article>
        ...
        <div class="btn-group">
          <% If IsUserLoginOK Then %>
            <a href="/my10x10/goodsusing.asp" target="_blank">
              상품후기 쓰러 가기
              <i class="icon-arrow">
                <img src="//webimage.10x10.co.kr/fixevent/event/2023/121872/m/btn-review-arrow.png" alt="" />
              </i>
            </a>
          <% Else %>
            <a href="" onclick="jsSubmitlogin(); return false;" class="btn-login">
              로그인 하기
              <i class="icon-arrow">
                <img src="//webimage.10x10.co.kr/fixevent/event/2023/121872/m/btn-login-arrow.png" alt="" />
              </i>
            </a>
          <% End If %>
        </div>
      </div>
      <span class="icon-coin"><img src="//webimage.10x10.co.kr/fixevent/event/2023/121872/icon-coin.png?v=1.1" alt=""></span>
    </div>
  </article>
  <article class="aram">
    <div class="text-box">
      <p class="sub-text">추가 마일리지 혜택 지급일 : 2월 8일 오후</p>
      <p class="sub-dscrp">&#42;추가 지급된 마일리지는 2월 28일까지 사용이 가능하며, 미사용 시 3월 1일 00:00에 소멸됩니다.</p>
    </div>
    <img src="//webimage.10x10.co.kr/fixevent/event/2023/121872/img-event-info.jpg" alt="이벤트 안내">
  ...
  <article class="info">
    ...
    <ul>
      ...
      <li><strong>이벤트로 추가 지급되는 마일리지(기본 후기는 100p, 포토 후기는 300p)는 후기 작성 후 바로 지급되지 않으며, 2월 8일 오후에 일괄 지급됩니다.</strong></li>
      <li><strong>이벤트로 추가 지급되는 마일리지는 2월 28일까지 사용이 가능하며, 미사용 시 3월 1일 00:00에 소멸됩니다.</strong></li>
