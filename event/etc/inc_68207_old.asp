...
.myMidori {background:#e3b48d;}
.myMidori ul {overflow:hidden; padding-left:88px;}
.myMidori ul li {position:relative; float:left; padding:0 17px; margin-bottom:30px;}
.myMidori ul li.pdt01 {margin-left:13px;}
...
function jsevtchk(){
	...
	<div class="contF">
		...
		<div class="evt68207">
			<h2><img src="http://webimage.10x10.co.kr/eventIMG/2015/68207/tit_modori.png" alt="MIDORI 창립 66주년, 당신의 매일을 풍요롭게 하다" /></h2>
			<div class="item">
				<img src="http://webimage.10x10.co.kr/eventIMG/2015/68207/img_item.jpg" alt="" usemap="#map01" />
					<map name="map01" id="map01">
					<area shape="rect" coords="123,51,322,367" href="#groupBar1" alt="다이어리 &amp; 캘린더" class="goBar" />
					<area shape="rect" coords="462,56,674,369" href="#groupBar2" alt="노트 &amp; 메모지" class="goBar" />
					<area shape="rect" coords="819,63,1031,369" href="#groupBar3" alt="필기류 &amp; 펜케이스" class="goBar" />
					<area shape="rect" coords="124,448,268,691" href="#groupBar4" alt="선물포장" class="goBar" />
					<area shape="rect" coords="357,463,525,691" href="#groupBar5" alt="스티커 &amp; 테이프" class="goBar" />
					<area shape="rect" coords="609,445,752,693" href="#groupBar6" alt="오피스 정리용품" class="goBar" />
					<area shape="rect" coords="817,470,1033,691" href="#groupBar7" alt="데스크 정리보관" class="goBar" />
				</map>
			</div>
			<!-- 투표하기 -->
			<div class="myMidori">
				<h3><img src="http://webimage.10x10.co.kr/eventIMG/2015/68207/txt_vote.png" alt="내가 좋아하는 MIDORi를 투표해주세요!" /></h3>
				<ul>
					<li class="pdt01">
						<label for="pdt01"><img src="http://webimage.10x10.co.kr/eventIMG/2015/68207/img_nominee_01.png" alt="트래블러스노트" /></label>
						<input type="radio" name="selridio" id="pdt01" value="1" />
					</li>
					<li class="pdt02">
						<label for="pdt02"><img src="http://webimage.10x10.co.kr/eventIMG/2015/68207/img_nominee_02.png" alt="MD노트" /></label>
						<input type="radio" name="selridio" id="pdt02" value="2" />
					</li>
					<li class="pdt03">
						<label for="pdt03"><img src="http://webimage.10x10.co.kr/eventIMG/2015/68207/img_nominee_03.png" alt="CL스테이셔너리" /></label>
						<input type="radio" name="selridio" id="pdt03" value="3" />
					</li>
					<li class="pdt04">
						<label for="pdt04"><img src="http://webimage.10x10.co.kr/eventIMG/2015/68207/img_nominee_04.png" alt="Brass Product" /></label>
						<input type="radio" name="selridio" id="pdt04" value="4" />
					</li>
					<li class="pdt05">
						<label for="pdt05"><img src="http://webimage.10x10.co.kr/eventIMG/2015/68207/img_nominee_05.png" alt="PET GIFT" /></label>
						<input type="radio" name="selridio" id="pdt05" value="5" />
					</li>
				</ul>
				<div class="btnArea">
					<a href="" onclick="jsevtchk(); return false;"><img src="http://webimage.10x10.co.kr/eventIMG/2015/68207/btn_vote.png" alt="투표하기" /></a>
					<a href="#" onclick="viewPoupLayer('modal',$('#layerVoteResult').html());return false;" target="_top"><img src="http://webimage.10x10.co.kr/eventIMG/2015/68207/btn_result.png" alt="결과보기" /></a>
				</div>
				<!-- 투표결과 레이어 -->
