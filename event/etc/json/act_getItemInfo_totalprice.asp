	...
	if Not(rsget.EOF or rsget.BOF) then
		...
		Do Until rsget.EOF
			...
			If rsget("sailyn") = "N" and rsget("itemcouponyn") = "N" Then
				oJson("items")(null)("itemprice") =  ""&formatNumber(rsget("orgprice"),0) & chkIIF(rsget("itemdiv")="82","Pt",sUnit) &""
			End If
			If rsget("sailyn") = "Y" and rsget("itemcouponyn") = "N" Then
				oJson("items")(null)("itemprice") =  ""&formatNumber(rsget("sellcash"),0) & chkIIF(rsget("itemdiv")="82","Pt",sUnit) &""
			End If
			if rsget("itemcouponyn") = "Y" And rsget("itemcouponvalue")>0 Then
				If rsget("itemcoupontype") = "1" Then
					oJson("items")(null)("itemprice") =  ""&formatNumber(rsget("sellcash") - CLng(rsget("itemcouponvalue")*rsget("sellcash")/100),0) & chkIIF(rsget("itemdiv")="82","Pt",sUnit) &""
				ElseIf rsget("itemcoupontype") = "2" Then
					oJson("items")(null)("itemprice") =  ""&formatNumber(rsget("sellcash") - rsget("itemcouponvalue"),0) & chkIIF(rsget("itemdiv")="82","Pt",sUnit) &""
			...
			ELSE
				If rsget("sailyn") = "Y" And rsget("itemcouponyn") = "Y" Then
					If rsget("itemcoupontype") = "1" Then
						'//할인 + %쿠폰
						oJson("items")(null)("saleper") = ""& CLng((rsget("orgprice")-(rsget("sellcash") - CLng(rsget("itemcouponvalue")*rsget("sellcash")/100)))/rsget("orgprice")*100)&"%"
						oJson("items")(null)("saleTag") = "sale"
					ElseIf rsget("itemcoupontype") = "2" Then
						'//할인 + 원쿠폰
						oJson("items")(null)("saleper") = ""& CLng((rsget("orgprice")-(rsget("sellcash") - rsget("itemcouponvalue")))/rsget("orgprice")*100)&"%"
						oJson("items")(null)("saleTag") = "sale"
					Else
						'//할인 + 무배쿠폰
						oJson("items")(null)("saleper") = ""& CLng((rsget("orgprice")-rsget("sellcash"))/rsget("orgprice")*100)&"%"
						oJson("items")(null)("saleTag") = "sale"
					End If 
				ElseIf rsget("sailyn") = "Y" and rsget("itemcouponyn") = "N" Then
					If CLng((rsget("orgprice")-rsget("sellcash"))/rsget("orgprice")*100)> 0 Then
						oJson("items")(null)("saleper") = ""& CLng((rsget("orgprice")-rsget("sellcash"))/rsget("orgprice")*100)&"%"
						oJson("items")(null)("saleTag") = "sale"
					else
						oJson("items")(null)("saleper") = ""
				...
				elseif rsget("sailyn") = "N" And rsget("itemcouponyn") = "Y" And rsget("itemcouponvalue")>0 Then
					...
					ElseIf rsget("itemcoupontype") = "3" Then
						oJson("items")(null)("saleper") = ""
					Else
						oJson("items")(null)("saleper") = ""& rsget("itemcouponvalue") &"%"
						oJson("items")(null)("saleTag") = "coupon"
					End If
				Else 
					oJson("items")(null)("saleper") = ""
...
'			oJson("items")(null)("sailyn") = rsget("sailyn") '// 세일 여부
'			oJson("items")(null)("itemcouponyn") = rsget("itemcouponyn") '// 쿠폰 여부
'			oJson("items")(null)("itemcoupontype") = rsget("itemcoupontype") '// 쿠폰 타입 1. 할인쿠폰 , 2. 원쿠폰 , 3.무배쿠폰
'			oJson("items")(null)("itemcouponvalue") = rsget("itemcouponvalue") '// 쿠폰값 
