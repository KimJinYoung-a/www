...
.maeileage {background-color:#45dbd1;}
...
.maeileage .noti li {color:#fff; padding:18px 0 0 11px; font-size:15px; line-height:16px; text-indent:-11px;}
...
<!-- 매일리지 -->
<div class="evt94814 maeileage">
	<div class="inner">
		<h2><img src="http://webimage.10x10.co.kr/fixevent/event/2019/94813/tit_maeileage.png" alt="매일 오면 점점 커지는 혜택!" /></h2>
		<p class="app-down"><img src="http://webimage.10x10.co.kr/fixevent/event/2019/94813/img_app_download.png" alt="텐바이텐 APP 다운받기" /></p>
	</div>
	<!-- 유의사항 -->
	<div class="noti">
		<div class="inner">
