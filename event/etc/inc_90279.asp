...
%>
<style>
.double-mileage {position:relative; background:#df8734;}
...
.noti {position:relative; padding:65px 0 65px 362px; margin-top:36px; background:#353535;}
...
function jsSubmitlogin(){
	...
	return false;
						...
						<%' 더블 마일리지 %>
						<div class="evt90279 double-mileage">
							<h2><img src="http://webimage.10x10.co.kr/fixevent/event/2018/90279/tit_double_mileage.png" alt="가장 기다렸던 이벤트! 11.6 ~ 11.11 단 6일간 상품 후기를 완성하면 마일리지 2배 적립!" /></h2>
							<p><img src="http://webimage.10x10.co.kr/fixevent/event/2018/90279/txt_mileage.png" alt="상품후기를 쓰면 200마일리지, 포토후기 작성시 추가 200마일리지 포함 400마일리지 지급" /></p>
							<%' 예상 마일리지 확인하기 %>
							<div class="my-mileage">
								...
								<div class="overHidden">
									...
									<div class="btn-group">
                                        <% If IsUserLoginOK Then %>
                                            <%' 로그인 후 %>
                                            <a href="/my10x10/goodsusing.asp"><img src="http://webimage.10x10.co.kr/fixevent/event/2018/90279/btn_review.png" alt="상품후기쓰러가기" /></a>
                                        <% Else %>
                                            <%' 로그인 전 %>
							...
							<!--// 예상 마일리지 확인하기 -->
							<div class="noti">
								<h3><img src="http://webimage.10x10.co.kr/fixevent/event/2018/90279/tit_noti.png" alt="이벤트 유의사항" /></h3>
								<ul>
									<li>· 이벤트 기간 내에 새롭게 작성하신 상품 후기에 한해서만 더블 마일리지가 적용됩니다.</li>
									<li>· 기존에 작성했던 상품후기 수정은 적용되지 않습니다.</li>
									<li style="color:#ffab5c;">· 상품 후기 및 포토후기가 작성된 이후에 삭제된 경우에는 마일리지 지급이 되지 않습니다.</li>
									...
									<li>· 포토 후기의 추가지급 마일리지(200point)는 11월 13일(화) 일괄지급 될 예정입니다.</li>
								</ul>
							</div>
						</div>
						<%'// 더블 마일리지 %>
