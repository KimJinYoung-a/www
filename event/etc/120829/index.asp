...
.evt118248 .section01{height:1158px; background:url(//webimage.10x10.co.kr/fixevent/event/2022/120829/section01.jpg) no-repeat 50% 0;}
.evt118248 .section01 .float img{position:absolute;}
.evt118248 .section01 .float01{left:50%; margin-left:-662px; top:239px; animation:updown .8s ease-in-out alternate infinite;}
.evt118248 .section01 .float02{ left:50%; margin-left:368px; top:90px; animation:updown .7s 0.4s ease-in-out alternate infinite;}
.evt118248 .section03_01{height:969px; background:url(//webimage.10x10.co.kr/fixevent/event/2022/120829/section02.jpg) no-repeat 50% 0;}
.evt118248 .section04_01{height:969px; background:url(//webimage.10x10.co.kr/fixevent/event/2022/120829/section03.jpg) no-repeat 50% 0;}
.evt118248 .section05_01{height:969px; background:url(//webimage.10x10.co.kr/fixevent/event/2022/120829/section04.jpg) no-repeat 50% 0;}
.evt118248 .section06_01{height:969px; background:url(//webimage.10x10.co.kr/fixevent/event/2022/120829/section05.jpg) no-repeat 50% 0;}
.evt118248 .section07{height:200px; background:url(//webimage.10x10.co.kr/fixevent/event/2022/120829/section06.jpg) no-repeat 50% 0;}
.evt118248 .sect_group{position:relative;}
.evt118248 .section03_01 .group_link{width:185px; height:202px; position:absolute; left:50%; margin-left:-371.5px; top:211px;}
.evt118248 .section04_01 .group_link{width:185px; height:202px; position:absolute; left:50%; margin-left:-240.5px; top:294px;}
.evt118248 .section05_01 .group_link{width:185px; height:202px; position:absolute; left:50%; margin-left:-49.5px; top:164px;}
.evt118248 .section06_01 .group_link{width:185px; height:202px; position:absolute; left:50%; margin-left:180.5px; top:211px;}
...
.evt118248 .layerDeal{top:1600px;}
.evt118248 .layerDeal .deal_list{padding:0 90px;padding-bottom:200px;margin-top:90px;}
.evt118248 .layerDeal .deal_list .itemDeal li > a:after{border:0;}
.evt118248 .layerDeal .deal_list .itemDeal .half{width:320px;height:437px;margin:0;margin-right:40px;margin-bottom:80px;}
.evt118248 .layerDeal .deal_list .itemDeal .half:nth-child(even){margin-right:0;}
.evt118248 .layerDeal .deal_list .itemDeal .half > a{width:320px;height:437px;padding:0;border:0;}
.evt118248 .layerDeal .deal_list .itemDeal .half .pdtPhoto, .evt120330 .layerDeal .deal_list .itemDeal .half .pdtPhoto img{width:320px;height:320px;margin-bottom:20px;}
.evt118248 .layerDeal .itemDeal .pdtInfo{width:320px;}
@keyframes updown {
...
<script src="/vue/event/etc/120829/index.js?v=1.1"></script>