    ...
    var fnWishList = {
        ...
        getMainHtml : function(v) {
            var tophtml = '<div class="wish-list">\
                        <p><img src="//webimage.10x10.co.kr/fixevent/event/2021/110079/tit_wish.png" alt="다른 사람들은 어떤 상품을 담았을까?"></p>\
                        <ul>'+ v +'</ul>\
                    </div>'
        ...
        getSubHtml : function(v) {
            ...
            subhtml = subhtml + '</div>';
            subhtml = subhtml + '</div>';
            subhtml = subhtml + '<button class="btn-bag" optcnt="'+ v.itemoptioncount +'" itemid="'+ v.itemid +'" orgprice="'+ v.sellcash +'"></button>';
            subhtml = subhtml + '</a>';
            subhtml = subhtml + '</li>';
