...
.box-tape .topic {position:relative; height:760px; background:url(//webimage.10x10.co.kr/fixevent/event/2022/116737/bg_main.jpg) no-repeat 50% 0;}
.box-tape .topic h2 {position:absolute; left:50%; top:215px; margin-left:-339.5px; opacity:0; transform:translateY(5%); transition:all 1s;}
.box-tape .topic .date {position:absolute; left:50%; top:350px; margin-left:-332.5px; opacity:0; transform:translateY(5%); transition:all 1s .3s;}
.box-tape .topic .animates.on {opacity:1; transform:translateY(0);}
.box-tape .section-01 {position:relative; height:1000px; background:url(//webimage.10x10.co.kr/fixevent/event/2022/116737/bg_sub01.jpg) no-repeat 50% 0;}
.box-tape .section-01 .txt01 {position:absolute; left:50%; top:169px; margin-left:-403.5px;}
.box-tape .section-01 .box {position:absolute; left:50%; top:423px; margin-left:-151.5px;}
.box-tape .section-01 .txt02 {position:absolute; left:50%; top:762px; margin-left:-295.5px;}
.box-tape .section-02 {position:relative; height:674px; background:url(//webimage.10x10.co.kr/fixevent/event/2022/116737/bg_sub02.jpg) no-repeat 50% 0;}
.box-tape .noti-area {background:#ebd2b4;}
.box-tape .noti-area .btn-detail {position:relative; width:100%; height:77px; background:url(//webimage.10x10.co.kr/fixevent/event/2022/116737/btn_detail.jpg) no-repeat 50% 0;}
.box-tape .noti-area .noti {display:none; height:254px; background:url(//webimage.10x10.co.kr/fixevent/event/2022/116737/img_detail.jpg) no-repeat 50% 0;}
.box-tape .noti-area .noti.on {display:block;}
.box-tape .noti-area .icon {position:absolute; left:50%; top:32px; margin-left:75px; width:18px; height:11px; transform: rotate(0);}
.box-tape .noti-area .icon.on {transform: rotate(180deg);}
.box-tape .section-03 {position:relative; height:1042px; background:url(//webimage.10x10.co.kr/fixevent/event/2022/116737/bg_sub03.jpg) no-repeat 50% 0;}
.box-tape .section-03 .btn-apply {position:absolute; left:0; bottom:140px; width:100%; height:120px; background:transparent;}
.box-tape .section-03 .apply-input {position:absolute; left:50%; top:475px; transform:translate(-50%,0); width:488px; height:52px; padding:24px 26px;}
...
.box-tape .section-04 {height:1195px; background:url(//webimage.10x10.co.kr/fixevent/event/2022/116737/bg_sub04.jpg) no-repeat 50% 0;}
.box-tape .section-05 .tit {height:278px; background:url(//webimage.10x10.co.kr/fixevent/event/2022/116737/tit_copy.jpg?v=2) no-repeat 50% 0;}
.box-tape .section-06 {position:relative; height:692px; background:url(//webimage.10x10.co.kr/fixevent/event/2022/116737/bg_sub05.jpg?v=1.01) no-repeat 50% 0;}
...
.box-tape .pop-container .pop-contents {position:relative; width:651px; margin:0 auto; top:50%; transform:translateY(-55%);}
.box-tape .pop-container .pop-contents .copy {position:absolute; left:50%; top:31.5%; transform:translate(-50%,0); overflow:hidden; margin:0 auto; padding:0; border:0; background:transparent; text-align:center; font-size:20px; color:#fff; width:calc(100% - 320px); height:63px; padding:0 20px; line-height:63px; overflow:hidden;font-family: '10X10';}
...
.box-tape .cmt-section .cmt-list li:nth-of-type(1), .box-tape .cmt-section .cmt-list li:nth-of-type(2) {margin-top:0;}
...
.box-tape .cmt-section .paging a span {height:100%; padding:0 14px 0 12px; color:#f33f27; font: 19.5px/34px 'CoreSansCRegular', 'AppleSDGothicNeo-Medium', 'NotoSansKRMedium', sans-serif; text-align:center;}
...
.box-tape .cmt-section .paging a.prev span {background-position:0 3px; background-image:url(//webimage.10x10.co.kr/fixevent/event/2022/116737/icon_arrow_left.png);}
.box-tape .cmt-section .paging a.next span {background-position:100% 3px; background-image:url(//webimage.10x10.co.kr/fixevent/event/2022/116737/icon_arrow_right.png);}
...
function fnClosePop(){
    location.href="/event/eventmain.asp?eventid=<%= eCode %>&pagereload=ON";
						...
						<div class="evt113476 box-tape">
							<div class="topic">
								<h2 class="animates"><img src="//webimage.10x10.co.kr/fixevent/event/2022/116737/tit_main.png" alt="텐바이텐 박스테이프 카피 공모전"></h2>
								<p class="date animates"><img src="//webimage.10x10.co.kr/fixevent/event/2022/116737/txt_main.png" alt="22.01.24 ㅡ 22.02.06"></p>
							</div>
                            <div class="section-01">
                                <div class="txt01 animate"><img src="//webimage.10x10.co.kr/fixevent/event/2022/116737/txt_sub01.png" alt=""></div>
                                <div class="box animate"><img src="//webimage.10x10.co.kr/fixevent/event/2022/116737/img_box.png" alt=""></div>
                                <div class="txt02 animate"><img src="//webimage.10x10.co.kr/fixevent/event/2022/116737/txt_sub02.png" alt=""></div>
                            </div>
                            <div class="section-02"></div>
                            <div class="noti-area">
                                <button type="button" class="btn-detail">
                                    <span class="icon"><img src="//webimage.10x10.co.kr/fixevent/event/2022/116737/icon_arrow.png" alt=""></span>
                                </button>
                                <div class="noti"></div>
                            </div>
                            ...
                            <div class="pop-container done">
                                <div class="pop-inner">
                                    <div class="pop-contents">
                                        <img src="//webimage.10x10.co.kr/fixevent/event/2022/116737/pop_done.png" alt="참여완료">
                                        <!-- 카피 문구 노출 -->
                                        <div class="copy">
                                            <%=evtcom_txt%>
                                        </div>
