...
<%
'###########################################################
' Description : 2016  지구를 돌려라
' History : 2016-06-21 유태욱
'###########################################################
%>
...
<form name="frm" action="inc_71239_manage_cs.asp" method="get">
<table class="table" style="width:90%;">
	<tr bgcolor="#ABF200">
		<td>
			<font><b>지구를 돌려라 응모자 및 당첨자  검색</b></font>
		</td>
	</tr>
	<tr bgcolor="#00D8FF">
		<td>
...
<% If returnuserid <> "a" Then %>
	...
	<table class="table" style="width:90%;">
<font size=5>
아이코닉코인월렛다낭 당첨일 경우 시스템팀에 문의해주세요.
</font>
		<tr align="center" bgcolor="#B2EBF4">
			<td>
				<font><b>70714 지구를 돌려라 당첨 내역</b></font>
			</td>
		</tr>
		<tr align="center" bgcolor="#B2EBF4">
		<b>
	...
	<%
		sqlstr = "select userid, value3, regdate "
