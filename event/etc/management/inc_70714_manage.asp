...
<%
	...
	sqlstr = sqlstr & " where evt_code='70715' and convert(varchar(10),regdate,120) ='"&returndate&"'"
	...
	sqlstr = sqlstr & " isnull(sum(case when sub_opt2 = '1111111' then 1 else 0 end),0) as item1, " + vbcrlf
	sqlstr = sqlstr & " isnull(sum(case when sub_opt2 = '2222222' then 1 else 0 end),0) as item2, " + vbcrlf
	sqlstr = sqlstr & " isnull(sum(case when sub_opt2 = '3333333' then 1 else 0 end),0) as item3, " + vbcrlf
	sqlstr = sqlstr & " isnull(sum(case when sub_opt2 = '0' then 1 else 0 end),0) as item4 " + vbcrlf
	sqlstr = sqlstr & " from db_event.dbo.tbl_event_subscript where evt_code = '"& eCode &"' and convert(varchar(10),regdate,120) ='"&returndate&"' " 
	rsget.Open sqlstr,dbget,1
	IF Not rsget.Eof Then
		wincnt1 = rsget("item1")	''폴라로이드
		wincnt2 = rsget("item2")	''아이리버
		wincnt3 = rsget("item3")	''베스킨
		wincnt4 = rsget("item4")	''무배쿠폰
	End If
	rsget.close()
...
'	sqlstr = sqlstr & " where eventid='70715' and convert(varchar(10),regdate,120) ='"&returndate&"' "
'	rsget.Open sqlstr, dbget, 1
'
'	If Not rsget.Eof Then
...
'	rsget.close
	...
	sqlstr = sqlstr & " from db_log.[dbo].[tbl_caution_event_log] where evt_code = '70715' and convert(varchar(10),regdate,120) ='"&returndate&"' " 
	rsget.Open sqlstr,dbget,1
	If Not rsget.Eof Then
		snscnt1 = rsget(0)
	End IF
...
<tr bgcolor="#FFFFFF" align="center">
	<td><a href="http://www.10x10.co.kr/event/etc/management/inc_70714_manage.asp?returndate=2016-05-16">2016-05-16 (월)</a></td>
	<td><a href="http://www.10x10.co.kr/event/etc/management/inc_70714_manage.asp?returndate=2016-05-17">2016-05-17 (화)</a></td>
	<td><a href="http://www.10x10.co.kr/event/etc/management/inc_70714_manage.asp?returndate=2016-05-18">2016-05-18 (수)</a></td>
	<td><a href="http://www.10x10.co.kr/event/etc/management/inc_70714_manage.asp?returndate=2016-05-19">2016-05-19 (목)</a></td>
	<td><a href="http://www.10x10.co.kr/event/etc/management/inc_70714_manage.asp?returndate=2016-05-20">2016-05-20 (금)</a></td>
	<td><a href="http://www.10x10.co.kr/event/etc/management/inc_70714_manage.asp?returndate=2016-05-21">2016-05-21 (토)</a></td>
	<td><a href="http://www.10x10.co.kr/event/etc/management/inc_70714_manage.asp?returndate=2016-05-22">2016-05-22 (일)</a></td>
	<td><a href="http://www.10x10.co.kr/event/etc/management/inc_70714_manage.asp?returndate=2016-05-23">2016-05-23 (월)</a></td>
</tr>																				            
</table>
<br>
...
<table class="table" style="width:90%;">
	...
	<tr align="center" bgcolor="#E6E6E6">
		<th><strong>오늘 70715 신청자</strong></th>
		<th><strong>오늘 70714 응모자</strong></th>
		<th><strong>[ 폴라로이드 ]</strong></th>
		<th><strong>[ 아이리버 ]</strong></th>
		<th><strong>[ 베스킨 ]</strong></th>
