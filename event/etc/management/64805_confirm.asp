...
If userid="thensi7" Or userid="bborami" Or userid="baboytw" Or userid="greenteenz" Or userid="cogusdk" Or userid="jinyeonmi" Or userid="ilovecozie" Or userid="boyishP" Then
...
<tr align="center">
	<th><strong>미니언즈 이벤트 당첨자 확인 페이지</strong></th>
</tr>
</table>
<br>
<form name="frm" method="post" action="/event/etc/management/64805_confirm.asp">
