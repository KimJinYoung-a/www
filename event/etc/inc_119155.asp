...
mktTest = False
End If
eventStartDate  = cdate("2022-06-21")		'이벤트 시작일
eventEndDate 	= cdate("2022-06-26")		'이벤트 종료일

if mktTest then
currentDate = cdate("2022-06-21")
else
currentDate = date()
end if
...
function eventTry(){
	...
	<% else %>
		...
		$.ajax({
			type:"POST",
			url:"/event/etc/doEventSubscript119155.asp",
			data: data,
			dataType: "JSON",
	...
	<% End If %>
						...
						<div class="evt111791 double-mileage">
							<h2><img src="//webimage.10x10.co.kr/fixevent/event/2022/117610/img_main.jpg?v=2" alt="더블 마일리지"></h2>
							<p><img src="//webimage.10x10.co.kr/fixevent/event/2022/117610/img_mge.jpg?v=2 alt=""></p>
							<div class="my-mileage">
								...
								<div class="overHidden">
									...
									<div class="btn-group">
                                        <% If IsUserLoginOK Then %>
										<a href="/my10x10/goodsusing.asp"><img src="//webimage.10x10.co.kr/fixevent/event/2021/116558/btn_goprd.png?v=2" alt="상품 후기 쓰러 가기"></a>
                                        <% Else %>
                            ...
                            <div class="sec-aram">
                                <img src="//webimage.10x10.co.kr/fixevent/event/2022/117610/img_alram.jpg?v=2" alt="이벤트 안내">
                                <button type="button" onclick="eventTry();"></button>
                            </div>
							<p><img src="//webimage.10x10.co.kr/fixevent/event/2022/117610/img_noti.jpg?v=2" alt="이벤트 유의사항"></p>
						</div>
