...
snpTitle	= Server.URLEncode("[행운의 편지] 텐바이텐 메일 수신 동의하고 기프트카드를 받아보세요!")
...
strPageDesc = "[행운의 편지] 텐바이텐 메일 수신 동의하고 기프트카드를 받아보세요!"
...
%>
<style>
.evt94436 button { background-color:transparent;}
.share,
.evt-conts,
.topic {position:relative;}
.topic .intro,
.topic span,
.topic h2 {position:absolute; top:180px; left:50%; margin-left:-221px;}
...
.noti {padding:50px 0; background:url(//webimage.10x10.co.kr/fixevent/event/2019/94436/bg_noti.jpg) no-repeat 0 0;}
.noti ul {padding-top:14px; padding-left:275px;}
.noti ul li {position:relative; padding-top:14px; color:#000; font-size:13px; line-height:1; font-weight:bold; text-align:left; letter-spacing:-.3px;}
...
.evt94436 .layer {position:absolute; top:0; left:0; z-index:20; width:100%; height:100%; background:url(//webimage.10x10.co.kr/fixevent/event/2019/94436/bg_pink.png) 0 0 repeat;}
.evt94436 .layer .inner {position:absolute; top:87px; left:50%; margin-left:-322px;}
.evt94436 .layer-detail {cursor:pointer;}
.evt94436 .layer-agree .inner {top:610px;}
.evt94436 .layer-agree .btn-group {position:absolute; top:250px; left:145px;}
.evt94436 .layer-agree .btn-group button {margin-right:50px;}
.evt94436 .layer-agree .btn-close {position:absolute; top:45px; right:80px; cursor:pointer;}
...
$(function() {
    ...
    $(".evt94436 .btn-detail").click(function(){
        $('.evt94436 .layer-detail').fadeIn();
    });
    // $(".evt94436 .btn-agree").click(function(){
    //     $('.evt94436 .layer-agree').fadeIn();
    // });
    $(".evt94436 .layer").click(function(){
        $(this).fadeOut();
    });
});
</script>
		...
		pinit('<%=snpLink%>','<%=snpImg%>');
			...
			<% end if %>			
						<div class="evt94436">
                            <div class="topic">
                                <h2>
                                    <img src="//webimage.10x10.co.kr/fixevent/event/2019/94436/tit_lucky_v2.png" alt="행운의 편지">
                                    <!--<button class=btn-detail><img src="//webimage.10x10.co.kr/fixevent/event/2019/94436/btn_detail.png" alt="자세히보기"></button>-->
                                </h2>
                                <span><img src="//webimage.10x10.co.kr/fixevent/event/2019/94436/img_envelope.png" alt=""></span>
                                <p class="intro"><img src="//webimage.10x10.co.kr/fixevent/event/2019/94436/txt_intro.png" alt="텐바이텐 메일을 수신 동의한 고객 중  추첨을 통해 행운의 편지를 보내드립니다 "></p>
                                <img src="//webimage.10x10.co.kr/fixevent/event/2019/94436/bg_lucky_v2.jpg" alt="">
                            </div>
                            <div class="evt-conts">
                                <img src="//webimage.10x10.co.kr/fixevent/event/2019/94436/txt_conts.jpg" alt="참여방법 1.위 버튼 클릭하고 텐바이텐 이메일 수신 동의하기! 2.2019년 6월 17일 행운의 편지 기다리기!">
                                <button class="btn-agree" type="button" onclick="chkLogin();">
                                    <img src="//webimage.10x10.co.kr/fixevent/event/2019/94436/btn_agree.png" alt="이메일 수신 동의하러가기">
                                    <i><img src="//webimage.10x10.co.kr/fixevent/event/2019/94436/txt_click.png" alt="클릭"></i>
                                </button>
                            </div>

                            <!-- 공유하기 -->
                            <div class="share">
                                <img src="//webimage.10x10.co.kr/fixevent/event/2019/94436/img_share.jpg" alt="행운의 편지 이벤트를 친구에게도 알려주세요!">
                                <ul>																					
                            ...
                            <div class="noti">
                                <h3><img src="//webimage.10x10.co.kr/fixevent/event/2019/94436/tit_noti.png" alt="이벤트 유의사항"></h3>
                                <ul>
                                    <li>본 이벤트는 텐바이텐 메일 수신 동의한 고객이라면 자동으로 응모되는 이벤트 입니다.</li>
                                    <li>이벤트 당첨자는 공지사항을 통해 발표할 예정입니다.</li>
                                    <li>메일 주소가 정확하지 않은 경우, 메일 발송이 불가합니다. <a href="/my10x10/userinfo/membermodify.asp" target="blank;">개인정보관리</a> 페이지에서 메일 주소를 확인해주세요.</li>
                            ...
                            <div class="layer layer-detail" style="display:none">
                                <div class="inner">
                                    <img src="//webimage.10x10.co.kr/fixevent/event/2019/94436/txt_congratulations.png" alt="이 편지는 미리보기이며, 텐바이텐 메일을 수신동의한 고객님 중  추첨을 통해 뽑힌 고객님만  받을 수 있습니다. ">
                                </div>
                            </div>
                            ...
                            <div class="layer layer-agree" style="display:none">
                                <div class="inner">
                                    <img src="//webimage.10x10.co.kr/fixevent/event/2019/94436/txt_agree.png" alt="이메일 수신동의 텐바이텐 이메일 수신 동의를 하시면 다양한 할인 혜택과 이벤트 ,신상품 등의 정보를 빠르게 만나실 수 있습니다. 텐바이텐 이메일로 다양한 정보를 받아 보시겠습니까?
                                   ">
                                    <div class="btn-group">
                                        <button type="button" onclick="doAction();"><img src="//webimage.10x10.co.kr/fixevent/event/2019/94436/btn_yes.png" alt="예"></button>
                                        <button><img src="//webimage.10x10.co.kr/fixevent/event/2019/94436/btn_no.png" alt="아니오"></button>
                                    </div>
                                    <button class="btn-close"><img src="//webimage.10x10.co.kr/fixevent/event/2019/94436/btn_close.png" alt="닫기"></button>
                                </div>
                            </div>
						</div>			
