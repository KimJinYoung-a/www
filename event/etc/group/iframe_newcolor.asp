...
<div id="navigator" class="navigator">
	<h2><img src="//webimage.10x10.co.kr/fixevent/event/2021/112368/tit_newitem.png" alt="컬러를 입은 Home"></h2>
	<div class="swiper-container">
		<ul class="swiper-wrapper">
			...
			<% Else %>
			<li class="swiper-slide open <%=CHKIIF(vEventID="112368"," current","")%>">
				<a href="/event/eventmain.asp?eventid=112368" target="_top">July</a>
			<% End If %>
			</li>
			...
			<% Else %>
			<li class="swiper-slide open <%=CHKIIF(vEventID="112726"," current","")%>">
				<a href="/event/eventmain.asp?eventid=112726" target="_top">August</a>
			<% End If %>
			</li>
