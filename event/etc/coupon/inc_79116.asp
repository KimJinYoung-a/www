...
%>
<style>
.evt79116 h2 {visibility:hidden; width:0; height:0;}
...
<div class="evt79116">
	...
	<div class="coupon">
		<div><img src="http://webimage.10x10.co.kr/eventIMG/2017/79116/img_coupon.png" alt="1만원 이상 구매 시 5천원 할인쿠폰 (앱전용)" /></div>
		<% If now() < #07/18/2017 23:59:59# then %>
			<% if couponcnt1 > 500 and couponcnt1 < 1000 then %>
			<!-- 마감임박 --><p class="hurry"><img src="http://webimage.10x10.co.kr/eventIMG/2017/79116/txt_hurryup.png" alt="마감임박" /></p>
			<% End If %>
			<% if couponcnt1 >= 1000 then %>
			<!-- 마감 --><p class="soldout"><a href="" onclick="jsevtDownCoupon('evttosel,','<%= getbonuscoupon1 %>,'); return false;"><img src="http://webimage.10x10.co.kr/eventIMG/2017/79116/txt_finish.png" alt="쿠폰이 마감되었습니다. 다음에 다시 도전하세요!" /></a></p>
			<% Else %>
			<% If now() >= #07/17/2017 10:00:00# And now() <= #07/17/2017 23:59:59# then %>
			<!-- 쿠폰 다운로드 --><p class="download"><a href="" onclick="jsevtDownCoupon('evttosel,','<%= getbonuscoupon1 %>,'); return false;"><img src="http://webimage.10x10.co.kr/eventIMG/2017/79116/btn_download.png" alt="쿠폰 다운받기" /></a></p>
			<% ElseIf now() >= #07/18/2017 10:00:00# And now() <= #07/18/2017 23:59:59# then %>
			<!-- 쿠폰 다운로드 --><p class="download"><a href="" onclick="jsevtDownCoupon('evttosel,','<%= getbonuscoupon1 %>,'); return false;"><img src="http://webimage.10x10.co.kr/eventIMG/2017/79116/btn_download.png" alt="쿠폰 다운받기" /></a></p>
			<% Else %>
			<!-- 오전10시 오픈 --><p class="open"><img src="http://webimage.10x10.co.kr/eventIMG/2017/79116/txt_open_10am.png" alt="오전 10시 오픈" /></p>
			<% End If %>
			<% End If %>
		<% Else %>
		<!-- 마감 --><p class="soldout"><img src="http://webimage.10x10.co.kr/eventIMG/2017/79116/txt_finish.png" alt="쿠폰이 마감되었습니다. 다음에 다시 도전하세요!" /></p>
		<!-- 마지막날 --><p class="lastday"><img src="http://webimage.10x10.co.kr/eventIMG/2017/79116/txt_last.png" alt="쿠폰이 마감되었습니다. 다음에 다시 도전하세요!" /></p>
		<% End If %>
	</div>
	<div><img src="http://webimage.10x10.co.kr/eventIMG/2017/79116/img_qr.png" alt="이벤트 유의사항 " /></div>
	<div class="evtNoti">
		<h3><img src="http://webimage.10x10.co.kr/eventIMG/2017/79116/tit_noti.png" alt="이벤트 유의사항 " /></h3>
		<ul>
