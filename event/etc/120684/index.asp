...
.evt120684 .section01{height:1288px; background:url(//webimage.10x10.co.kr/fixevent/event/2022/120684/section01.jpg) no-repeat 50% 0;}
...
.evt120684 .section03{height:2018px; background:url(//webimage.10x10.co.kr/fixevent/event/2022/120684/section02.jpg) no-repeat 50% 0;}
.evt120684 .section03 .brand_prd{position:absolute;left:50%;transform:translateX(-50%);bottom:453px;width:787px;height:295px;}
.evt120684 .section03 .brand_prd a{width:787px;height:295px;display:block;}
.evt120684 .section03 .brand{position:absolute;left:50%;transform:translateX(-50%);bottom:333px;width:306px;height:76px;}
.evt120684 .section03 .brand a{width:306px;height:76px;display:block;}

.evt120684 .section04{height:979px; background:url(//webimage.10x10.co.kr/fixevent/event/2022/120684/section03.jpg) no-repeat 50% 0;}
.evt120684 .section04 .mySwiper{width:1140px;position:relative;top:502px;left:50%;margin-left:-570px;padding-left:50px;}
...
.evt120684 .section05{height:1932px; background:url(//webimage.10x10.co.kr/fixevent/event/2022/120684/section04.jpg) no-repeat 50% 0;}
.evt120684 .section05 .flex01{display:flex;justify-content:space-between;width:1140px;margin:0 auto;padding-top:235px;}
.evt120684 .section05 .flex01:first-child{padding-top:534px;}
...
.evt120684 .section06{height:598px; background:url(//webimage.10x10.co.kr/fixevent/event/2022/120684/section05.jpg) no-repeat 50% 0;}
.evt120684 .section06 .diary{display:flex;justify-content:space-between;width:838px;margin:0 auto;padding-top:290px;}
.evt120684 .section06 .diary a{width:400px;height:75px;display:block;}

.evt120684 .section07{margin-top:60px;margin-bottom:150px;}
...
<script src="/vue/event/etc/120684/index.js?v=1.1"></script>