...
eventEndDate 	= cdate("2022-04-01")		'이벤트 종료일

if mktTest then
currentDate = cdate("2022-03-28")
else
currentDate = date()
end if
...
function eventTry(){
	...
	<% else %>
		...
		$.ajax({
			type:"POST",
			url:"/event/etc/doEventSubscript117610.asp",
			data: data,
			dataType: "JSON",
	...
	<% End If %>
						...
						<div class="evt111791 double-mileage">
							<h2><img src="//webimage.10x10.co.kr/fixevent/event/2022/117610/img_main.jpg" alt="더블 마일리지"></h2>
                            ...
                            <div class="sec-aram">
                                <img src="//webimage.10x10.co.kr/fixevent/event/2022/117610/img_alram.jpg" alt="이벤트 안내">
                                <button type="button" onclick="eventTry();"></button>
                            </div>
							<p><img src="//webimage.10x10.co.kr/fixevent/event/2022/117610/img_noti.jpg" alt="이벤트 유의사항"></p>
						</div>
