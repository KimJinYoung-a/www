...
snpTitle	= Server.URLEncode("단 3일간! 스페셜 마일리지를 사용해보세요!")
...
strPageDesc = "단 3일간! 스페셜 마일리지를 사용해보세요!"
strPageUrl = "http://www.10x10.co.kr/event/eventmain.asp?eventid=" & eCode
strPageImage = "http://webimage.10x10.co.kr/fixevent/event/2019/96304/img_kakao.jpg"
%>
<style type="text/css">
.evt96304 {position:relative;}
.evt96304 .txt-only {position:absolute; top:88px; left:50%; margin-left:136px; animation:bounce 1s 30;}
.evt96304 .btn-mileage {position:absolute; top:535px; left:50%; margin-left:-163px; background:none; animation:shake .7s 40;}
@keyframes bounce {
...
.evt96304 .bot {overflow:hidden; display:flex;}
.evt96304 .share {position:relative;}
.evt96304 .share a {position:absolute; top:100px; width:130px; height:130px; font-size:0; color:transparent;}
.evt96304 .share a:first-child {left:140px;}
.evt96304 .share a:last-child {left:300px;}
.evt96304 .bnr a {display:block;}
</style>
...
function snschk(snsnum) {
	if(snsnum == "tw") {
		...
		pinit('<%=snpLink%>','<%=snpImg%>');
			...
			<% end if %>
			<div class="evt96304">
				<p><img src="//webimage.10x10.co.kr/fixevent/event/2019/96304/img_evt.jpg" alt="3333 마일리지"></p>
				<span class="txt-only"><img src="//webimage.10x10.co.kr/fixevent/event/2019/96304/txt_only.png" alt="단 3일간"></span>
				<button type="button" class="btn-mileage" onclick="doAction();"><img src="//webimage.10x10.co.kr/fixevent/event/2019/96304/btn_mileage.gif" alt="마일리지 받기"></button>
				<div class="bot">
					<div class="share">
						<a href="javascript:snschk('fb');">facebook 페이스북</a>
						<img src="//webimage.10x10.co.kr/fixevent/event/2019/96304/bnr_share.jpg" alt="7월 마일리지 이벤트 친구에게 공유하기">
						<a href="javascript:snschk('tw');">twitter 트위터</a>
					</div>
					<div class="bnr">
						<a href="/event/eventmain.asp?eventid=96262"><img src="//webimage.10x10.co.kr/fixevent/event/2019/96304/bnr_01.jpg" alt="텐텐차트 20"></a>
						<a href="/event/eventmain.asp?eventid=96002"><img src="//webimage.10x10.co.kr/fixevent/event/2019/96304/bnr_02.jpg" alt="여름날의 원피스"></a>
					</div>
				</div>
			</div>
