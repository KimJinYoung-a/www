...
snpTitle	= Server.URLEncode("단 하루 사용 가능한 스페셜 마일리지를 받아보세요!")
...
strPageDesc = "단 하루 사용 가능한 스페셜 마일리지를 받아보세요!"
strPageUrl = "http://www.10x10.co.kr/event/eventmain.asp?eventid=" & eCode
strPageImage = ""
%>
<style type="text/css">
.eventContV15 div.contW {width:1140px; background-color:#fff;}
.gpimg {display:none;}
.evt95252 {position:relative;}
.evt95252 .txt-oneday {position:absolute; top:89px; right:202px; animation:bounce1 .7s 30;}
.evt95252 .btn-submit {position:absolute; top:862px; left:0; width:100%; background:none; animation:bounce2 .7s 40;}
@keyframes bounce1 {
...
function snschk(snsnum) {
	if(snsnum == "tw") {
		...
		pinit('<%=snpLink%>','<%=snpImg%>');
			...
			<!-- 급마일리지 -->
			<div class="evt95252">
				<div><img src="//webimage.10x10.co.kr/fixevent/event/2019/95252/img_evt_v3.jpg" alt="12시 깜짝 마일리지"></div>
				<span class="txt-oneday"><img src="//webimage.10x10.co.kr/fixevent/event/2019/95252/txt_oneday.png" alt="단 하루"></span>
				<button class="btn-submit" onclick="doAction()"><img src="//webimage.10x10.co.kr/fixevent/event/2019/95252/btn_submit.png" alt="마일리지 받기" /></button>
			</div>
			<!-- // 급마일리지 -->
