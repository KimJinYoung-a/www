...
%>
<style>
.double-mileage {position:relative; background:#465795;}
...
<div class="evt82595 double-mileage">
	<h2><img src="http://webimage.10x10.co.kr/eventIMG/2017/82595/tit_double_mileage.png" alt="X2 마일리지 - 오늘 하루 동안 상품후기 작성하면 마일리지 2배 적립!" /></h2>
	<p><img src="http://webimage.10x10.co.kr/eventIMG/2017/82595/txt_mileage.png" alt="상품후기를 쓰면 200마일리지, 첫 상품후기를 쓰면 400마일리지 적립" /></p>
	<div class="my-mileage">
		<% If IsUserLoginOK Then %>
		<h3><strong><%= vUserID %></strong><img src="http://webimage.10x10.co.kr/eventIMG/2017/82595/txt_get_mileage.png" alt="고객님의 예상 마일리지는?" /></h3>
		<% Else %>
		...
		<div class="overHidden">
			...
			<div class="btn-group">
				<% If IsUserLoginOK Then %>
				<a href="/my10x10/goodsusing.asp"><img src="http://webimage.10x10.co.kr/eventIMG/2017/82595/btn_review.png" alt="상품후기쓰고 더블 마일리지 받기" /></a>
				<% Else %>
				<a href="" onclick="jsSubmitlogin(); return false;"><img src="http://webimage.10x10.co.kr/eventIMG/2017/82595/btn_login.png" alt="로그인하기" /></a>
				<% End If %>
			</div>
		</div>
	</div>
	<div class="noti">
		<h3><img src="http://webimage.10x10.co.kr/eventIMG/2017/82595/tit_noti.png" alt="이벤트 유의사항" /></h3>
		<ul>
