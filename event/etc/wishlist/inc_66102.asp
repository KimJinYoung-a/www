...
<div class="evt66102">
	<h2>
		<img src="http://webimage.10x10.co.kr/eventIMG/2015/66102/tit_my_wedding_wish.jpg" alt="MY DREAM HOUSE V.4 내가 꿈꾸는 거실" usemap="#goEvt" />
		<map name="goEvt" id="goEvt">
			<area shape="rect" coords="1,1,148,142" href="/event/eventmain.asp?eventid=66036" alt="거실 기획전 바로가기" />
		</map>
	</h2>
	<p class="makeFolder"><a href="" onclick="jsSubmit(); return false;"><img src="http://webimage.10x10.co.kr/eventIMG/2015/66102/btn_make_folder.png" alt="[내가 꿈꾸는 거실] 위시폴더 만들고 이벤트 참여하기" /></a></p>
	<div class="myWeddingWish">
		<% If IsUserLoginOK() Then %>
			<% if vCount > 0 then %>
				<div class="putMyWish">
					<div class="myFolder">
						<span><%= userid %></span><img src="http://webimage.10x10.co.kr/eventIMG/2015/66102/txt_my_folder.png" alt="<%= userid %>님의 [내가 꿈꾸는 거실] 위시 폴더" />
						<a href="/my10x10/mywishlist.asp" target="_top"><img src="http://webimage.10x10.co.kr/eventIMG/2015/66102/btn_go_mywish.gif" alt="나의 위시 보러가기" /></a>
					</div>
					<div class="putList">
						<ul>
					...
					<p><img src="http://webimage.10x10.co.kr/eventIMG/2015/66102/txt_tip.gif" alt="최소 5개 이상의 상품을 담아주셔야 당첨이 됩니다." /></p>
				</div>
			<% else %>
				<p style="display:block;"><img src="http://webimage.10x10.co.kr/eventIMG/2015/66102/img_apply_process.png" alt="이벤트 참여방법" /></p>
			<% end if %>
		<% else %>
			<p style="display:block;"><img src="http://webimage.10x10.co.kr/eventIMG/2015/66102/img_apply_process.png" alt="이벤트 참여방법" /></p>
		<% end if %>
	...
	<div class="friendsWish">
		<h3><img src="http://webimage.10x10.co.kr/eventIMG/2015/66102/tit_friends_wish.png" alt="다른 친구들의 [내가 꿈꾸는 거실] 폴더를 둘러보세요!" /></h3>
	...
	<div class="evtNoti">
		<dl>
			<dt><img src="http://webimage.10x10.co.kr/eventIMG/2015/66102/tit_noti.gif" alt="유의사항은 꼭 읽어주세요!" /></dt>
			<dd>
				<ul>
					<li><img src="http://webimage.10x10.co.kr/eventIMG/2015/66102/btn_apply.gif" alt="참여하기" /> 클릭 시, 위시리스트에 &lt;내가 꿈꾸는 거실&gt; 폴더가 자동 생성 됩니다.</li>
					<li>본 이벤트에서 <img src="http://webimage.10x10.co.kr/eventIMG/2015/66102/btn_apply.gif" alt="참여하기" />를 클릭하셔야만 이벤트 참여가 가능합니다.</li>
		...
		<p><img src="http://webimage.10x10.co.kr/eventIMG/2015/66102/img_wish_ex.png" alt="" /></p>
	</div>
	<%
