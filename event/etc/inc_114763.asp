...
function eventTry(){
	...
	<% End If %>
						...
						<div class="evt111791 double-mileage">
							<h2><img src="//webimage.10x10.co.kr/fixevent/event/2021/114763/img_main.jpg" alt="더블 마일리지"></h2>
							<p><img src="//webimage.10x10.co.kr/fixevent/event/2021/114763/img_mge.jpg" alt=""></p>
							<div class="my-mileage">
								...
								<div class="overHidden">
									...
									<div class="btn-group">
                                        <% If IsUserLoginOK Then %>
										<a href="/my10x10/goodsusing.asp"><img src="//webimage.10x10.co.kr/fixevent/event/2021/114763/btn_goprd.png" alt="상품 후기 쓰러 가기"></a>
                                        <% Else %>
                            ...
                            <div class="sec-aram">
                                <img src="//webimage.10x10.co.kr/fixevent/event/2021/114763/img_aram.jpg" alt="이벤트 안내">
                                <button type="button" onclick="eventTry();"></button>
                            </div>
							<p><img src="//webimage.10x10.co.kr/fixevent/event/2021/114763/img_noti.jpg" alt="이벤트 유의사항"></p>
						</div>
