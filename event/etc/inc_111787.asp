                                ...
                                <div class="special-item">
                                    ...
                                    <% If currentDate >= #06/21/2021 00:00:00# and currentDate < #06/22/2021 00:00:00# Then %>
                                        ...
                                        <li class="<% if episode=0 then %>not-open<% elseIf getitemlimitcnt(episode1Itemid) < 1 then %>sold-out<% End If %>">
                                            <div class="product-inner">
                                                <div class="thum">
                                                    <img src="//webimage.10x10.co.kr/eventIMG/deal_itemImage/202106/deal_itemImage20210617152648.jpg" alt="소니 WH-1000XM4 노이즈 캔슬링 헤드폰 실버">
                                        ...
                                        <li class="<% If getitemlimitcnt(episode2Itemid) < 1 then %>sold-out<% End If %>">
                                            <div class="product-inner">
                                                <div class="thum">
                                                    <img src="//webimage.10x10.co.kr/eventIMG/deal_itemImage/202106/deal_itemImage20210617175313.jpg" alt="스누피 리유저블 콜드컵 5개세트 4,900원 특가!">
                                        ...
                                        <li class="<% If getitemlimitcnt(episode3Itemid) < 1 then %>sold-out<% End If %>">
                                            <div class="product-inner">
                                                <div class="thum">
                                                    <img src="//webimage.10x10.co.kr/eventIMG/deal_itemImage/202106/deal_itemImage20210617175507.jpg" alt="[클레어] 무선선풍기">
                                                    <span class="num-limite"><em>5</em>개 한정</span>
                                                </div>
                                                <div class="desc">
                                        ...
                                        <li class="<% If getitemlimitcnt(episode4Itemid) < 1 then %>sold-out<% End If %>">
                                            <div class="product-inner">
                                                <div class="thum">
                                                    <img src="//webimage.10x10.co.kr/eventIMG/deal_itemImage/202106/deal_itemImage20210617175750.jpg" alt="헤이릴렉스캄다운 코퍼비치 캔버스 릴렉스체어 (BEIGE)">
                                    ...
                                    <% elseIf currentDate >= #06/23/2021 00:00:00# and currentDate < #06/24/2021 00:00:00# Then %>
                                        ...
                                        <li class="<% if episode=0 then %>not-open<% elseIf getitemlimitcnt(episode1Itemid) < 1 then %>sold-out<% End If %>">
                                            <div class="product-inner">
                                                <div class="thum">
                                                    <img src="//webimage.10x10.co.kr/eventIMG/deal_itemImage/202106/deal_itemImage20210622095945.jpg" alt="[스탠리공식유통사] 클래식 런치 박스 9.4L">
                                                    <span class="num-limite"><em>20</em>개 한정</span>
                                                </div>
                                                <div class="desc">
                                        ...
                                        <li class="<% If getitemlimitcnt(episode2Itemid) < 1 then %>sold-out<% End If %>">
                                            <div class="product-inner">
                                                <div class="thum">
                                                    <img src="//webimage.10x10.co.kr/eventIMG/deal_itemImage/202106/deal_itemImage20210622100114.jpg" alt="디즈니 푸 토스터기 9,900원 특가!">
                                                    <span class="num-limite"><em>20</em>개 한정</span>
                                                </div>
                                                <div class="desc">
                                        ...
                                        <li class="<% If getitemlimitcnt(episode3Itemid) < 1 then %>sold-out<% End If %>">
                                            <div class="product-inner">
                                                <div class="thum">
                                                    <img src="//webimage.10x10.co.kr/eventIMG/deal_itemImage/202106/deal_itemImage20210622100227.jpg" alt="스마트미 2S 스탠드 무선선풍기 리모컨포함">
                                                    <span class="num-limite"><em>5</em>개 한정</span>
                                                </div>
                                                <div class="desc">
                                                    <p class="name">스마트미 2S 스탠드 무선선풍기 리모컨포함</p>
                                                    <div class="price"><s>129,000</s> 10,000 <span class="p-won">원</span><span class="sale">92%</span></div>
                                                </div>
                                                <% if getitemlimitcnt(episode3Itemid) < 1 then%>
                                                <% else %>
                                                <div class="go-link">
                                        ...
                                        <li class="<% If getitemlimitcnt(episode4Itemid) < 1 then %>sold-out<% End If %>">
                                            <div class="product-inner">
                                                <div class="thum">
                                                    <img src="//webimage.10x10.co.kr/eventIMG/deal_itemImage/202106/deal_itemImage20210622100340.jpg" alt="[BRAUN] 브라운 제모의료기기 PL 5124">
                                                    <span class="num-limite"><em>5</em>개 한정</span>
                                                </div>
                                                <div class="desc">
                                ...
                                <div class="product-list">
                                    ...
                                    <% elseIf currentDate >= #06/23/2021 00:00:00# and currentDate < #06/24/2021 00:00:00# Then %>
                                        ...
                                        <li>
                                            <img src="//webimage.10x10.co.kr/fixevent/event/2021/111787/time_header_02.png" alt="오전 12시">
                                            <div class="product-inner">
                                                <img src="//webimage.10x10.co.kr/eventIMG/deal_tzImage/202106/deal_tzImage20210622100114.jpg" alt="디즈니 푸 토스터기 9,900원 특가!">
                                                <span class="num-limite"><em>20</em>개 한정</span>
                                            </div>
                                        </li>
                                        <% end if %>
                                        ...
                                        <li>
                                            <img src="//webimage.10x10.co.kr/fixevent/event/2021/111787/time_header_03.png" alt="오후 15시">
                                            <div class="product-inner">
                                                <img src="//webimage.10x10.co.kr/eventIMG/deal_tzImage/202106/deal_tzImage20210622100227.jpg" alt="스마트미 2S 스탠드 무선선풍기 리모컨포함">
                                                <span class="num-limite"><em>5</em>개 한정</span>
                                            </div>
                                        </li>
                                        <% end if %>
                                        ...
                                        <li>
                                            <img src="//webimage.10x10.co.kr/fixevent/event/2021/111787/time_header_04.png" alt="오후 18시">
                                            <div class="product-inner">
                                                <img src="//webimage.10x10.co.kr/eventIMG/deal_tzImage/202106/deal_tzImage20210622100340.jpg" alt="[BRAUN] 브라운 제모의료기기 PL 5124">
                                                <span class="num-limite"><em>5</em>개 한정</span>
                                            </div>
                                        </li>
                                        <% end if %>
                                        ...
                                        <div class="swiper-container">
                                            ...
                                            <% If currentDate >= #06/21/2021 00:00:00# and currentDate < #06/22/2021 00:00:00# Then %>
                                                <li class="swiper-slide sold-prd<% If getitemlimitcnt(episode1Itemid) < 1 then %> sold-out<% End If %>">
                                                    <div class="tit-prd">
                                                        <div class="thum"><img src="//webimage.10x10.co.kr/eventIMG/deal_soldoutImage/202106/deal_soldoutImage20210617152648.png" alt="상품1"></div>
                                                        <div class="desc">
                                                            <p class="name">소니 WH-1000XM4 노이즈 캔슬링 헤드폰 실버</p>
                                                            <div class="price"><s>359,100</s> 100,000 <span class="p-won">원</span><span class="sale">72%</span></div>
                                                        </div>
                                                ...
                                                <li class="swiper-slide sold-prd<% If getitemlimitcnt(episode2Itemid) < 1 then %> sold-out<% End If %>">
                                                    <div class="tit-prd">
                                                        <div class="thum"><img src="//webimage.10x10.co.kr/eventIMG/deal_soldoutImage/202106/deal_soldoutImage20210617175313.png" alt="상품2"></div>
                                                        <div class="desc">
                                                            <p class="name">스누피 리유저블 콜드컵 5개세트 4,900원 특가!</p>
                                                            <div class="price"><s>24,000</s> 4,900 <span class="p-won">원</span><span class="sale">80%</span></div>
                                                        </div>
                                                ...
                                                <li class="swiper-slide sold-prd<% If getitemlimitcnt(episode3Itemid) < 1 then %> sold-out<% End If %>">
                                                    <div class="tit-prd">
                                                        <div class="thum"><img src="//webimage.10x10.co.kr/eventIMG/deal_soldoutImage/202106/deal_soldoutImage20210617175507.png" alt="상품3"></div>
                                                        <div class="desc">
                                                            <p class="name">[클레어] 무선선풍기</p>
                                                            <div class="price"><s>248,000</s> 10,000 <span class="p-won">원</span><span class="sale">96%</span></div>
                                                        </div>
                                                ...
                                                <li class="swiper-slide sold-prd<% If getitemlimitcnt(episode4Itemid) < 1 then %> sold-out<% End If %>">
                                                    <div class="tit-prd">
                                                        <div class="thum"><img src="//webimage.10x10.co.kr/eventIMG/deal_soldoutImage/202106/deal_soldoutImage20210617175750.png" alt="상품4"></div>
                                                        <div class="desc">
                                                            <p class="name">헤이릴렉스캄다운 코퍼비치 캔버스 릴렉스체어 (BEIGE)</p>
                                                            <div class="price"><s>89,800</s> 13,900 <span class="p-won">원</span><span class="sale">85%</span></div>
                                                        </div>
                                            ...
                                            <% elseif currentDate >= #06/23/2021 00:00:00# and currentDate < #06/24/2021 00:00:00# Then %>
                                                <li class="swiper-slide sold-prd<% If getitemlimitcnt(episode1Itemid) < 1 then %> sold-out<% End If %>">
                                                    <div class="tit-prd">
                                                        <div class="thum"><img src="//webimage.10x10.co.kr/eventIMG/deal_soldoutImage/202106/deal_soldoutImage20210622095945.png" alt="상품1"></div>
                                                        <div class="desc">
                                                            <p class="name">[스탠리공식유통사] 클래식 런치 박스 9.4L</p>
                                                            <div class="price"><s>75,000</s> 9,900 <span class="p-won">원</span><span class="sale">87%</span></div>
                                                        </div>
                                                ...
                                                <li class="swiper-slide sold-prd<% If getitemlimitcnt(episode2Itemid) < 1 then %> sold-out<% End If %>">
                                                    <div class="tit-prd">
                                                        <div class="thum"><img src="//webimage.10x10.co.kr/eventIMG/deal_soldoutImage/202106/deal_soldoutImage20210622100114.png" alt="상품2"></div>
                                                        <div class="desc">
                                                            <p class="name">디즈니 푸 토스터기 9,900원 특가!</p>
                                                            <div class="price"><s>69,000</s> 9,900 <span class="p-won">원</span><span class="sale">86%</span></div>
                                                        </div>
                                                ...
                                                <li class="swiper-slide sold-prd<% If getitemlimitcnt(episode3Itemid) < 1 then %> sold-out<% End If %>">
                                                    <div class="tit-prd">
                                                        <div class="thum"><img src="//webimage.10x10.co.kr/eventIMG/deal_soldoutImage/202106/deal_soldoutImage20210622100227.png" alt="상품3"></div>
                                                        <div class="desc">
                                                            <p class="name">스마트미 2S 스탠드 무선선풍기 리모컨포함</p>
                                                            <div class="price"><s>129,000</s> 10,000 <span class="p-won">원</span><span class="sale">92%</span></div>
                                                        </div>
                                                ...
                                                <li class="swiper-slide sold-prd<% If getitemlimitcnt(episode4Itemid) < 1 then %> sold-out<% End If %>">
                                                    <div class="tit-prd">
                                                        <div class="thum"><img src="//webimage.10x10.co.kr/eventIMG/deal_soldoutImage/202106/deal_soldoutImage20210622100340.png" alt="상품4"></div>
                                                        <div class="desc">
                                                            <p class="name">[BRAUN] 브라운 제모의료기기 PL 5124</p>
                                                            <div class="price"><s>549,000</s> 99,000 <span class="p-won">원</span><span class="sale">82%</span></div>
                                                        </div>
