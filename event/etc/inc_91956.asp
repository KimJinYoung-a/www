...
%>
<style type="text/css">
.evt91956 .topic {position:relative; background:#ff7c95 url(//webimage.10x10.co.kr/fixevent/event/2019/91956/bg_topic.jpg) 50% 0 repeat-x;}
...
.evt91956 .info .slide .slidesjs-pagination a {display:inline-block; width:100%; height:100%; background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/91956/txt_info.png); background-repeat:no-repeat; background-position:0 0; text-indent:-999em;}
...
.cmt-area {background-color:#c1e1ee; font-family:"malgun Gothic","맑은고딕";}
.cmt-area h4 {padding:100px 0 60px;}
.cmt-area .inner {width:1140px; margin:0 auto; text-align:left;}
.caution {margin:27px 0 0 70px;}
.cmt-area .input-box {position:relative; padding:30px; background-color:#b1d8e8;}
...
.cmt-list .conts {position:relative; height:256px; padding:0 16px; margin-top:18px; font-size:14px; line-height:2; font-weight:500; word-wrap:break-word; word-break: break-all;}
.cmt-list .conts:after {display:inline-block; position:absolute; bottom:-29px; left:-26px; width:333px; height:29px; background:url(//webimage.10x10.co.kr/fixevent/event/2019/91956/bg_cmt_1.png) 50% 50% no-repeat; content:'';}
.cmt-list li:nth-child(2n) .conts:after {background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/91956/bg_cmt_2.png)}
...
.cmt-list .paging a span {width:34px; height:34px; padding:0; font-size:16px; color:#61a2bc; font-family:"malgun Gothic","맑은고딕";}
...
.cmt-list .paging a.prev span {background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/91956/btn_cmt_prev.png);}
.cmt-list .paging a.next span {background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/91956/btn_cmt_next.png);}
...
.noti ul li {padding-left:399px; margin:10px 0; color:#dadce1; font-weight:bold; font-family:"malgun Gothic","맑은고딕"; text-indent:-12px;}
...
<div class="evt91956">
    <%' 최상단 %>
    <div class="topic">
        <h2><img src="//webimage.10x10.co.kr/fixevent/event/2019/91956/tit_bucket_v2.png" alt="MYDANO와 함께 다이어트"></h2>
        <p><img src="//webimage.10x10.co.kr/fixevent/event/2019/91956/img_winner.png" alt="총 당첨자 100명!"></p>
        <i></i>
    </div>

    <%' 브랜드 소개 %>
    <div class="info">
        <h3><img src="//webimage.10x10.co.kr/fixevent/event/2019/91956/tit_info.png" alt="마이다노가 궁금해요!"></h3>
        <div class="slide">
            <div class="swiper-slide"><a href="javascript:void(0)"><img src="//webimage.10x10.co.kr/fixevent/event/2019/91956/img_slide_1.jpg" alt="굶는 다이어트는 이제 그만! 평생 유지 가능한 건강한 식습관 만들 수 있어요." /></a></div>
            <div class="swiper-slide"><a href="javascript:void(0)"><img src="//webimage.10x10.co.kr/fixevent/event/2019/91956/img_slide_2.jpg" alt="무리하게 운동하지 마세요! 하루 30분씩 짧지만 효과 좋은 운동을 즐길 수 있어요." /></a></div>
            <div class="swiper-slide"><a href="javascript:void(0)"><img src="//webimage.10x10.co.kr/fixevent/event/2019/91956/img_slide_3.jpg" alt="일상을 바꾸면 인생이 달려져요! 나에게 꼭 필요한  미션을 하다 보면 어느새 습관이 바뀌어요." /></a></div>
            <div class="swiper-slide"><a href="javascript:void(0)"><img src="//webimage.10x10.co.kr/fixevent/event/2019/91956/img_slide_4.jpg" alt="국내 최대 규모 여성 코치진! 여성 다이어트만을 연구하는 여성 코치님들이 세심하게 관리해줘요." /></a></div>
        </div>
    </div>

    <%' 코멘트 %>
    <div class="cmt-area">
        <h4><img src="//webimage.10x10.co.kr/fixevent/event/2019/91956/txt_cmt_evt.png" alt="평소 다이어트를 할 때 고민이었던 점을 남겨주세요!"></h4>
        <div class="inner">
