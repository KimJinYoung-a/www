...
mktTest = False
End If
eventStartDate  = cdate("2022-05-03")		'이벤트 시작일
eventEndDate 	= cdate("2022-05-06")		'이벤트 종료일

if mktTest then
currentDate = cdate("2022-05-03")
else
currentDate = date()
end if
...
function eventTry(){
	...
	<% else %>
		...
		$.ajax({
			type:"POST",
			url:"/event/etc/doEventSubscript118373.asp",
			data: data,
			dataType: "JSON",
	...
	<% End If %>
						...
						<div class="evt111791 double-mileage">
							<h2><img src="//webimage.10x10.co.kr/fixevent/event/2022/118373/img_main.jpg" alt="더블 마일리지"></h2>
							<p><img src="//webimage.10x10.co.kr/fixevent/event/2022/118373/img_mge.jpg" alt=""></p>
							<div class="my-mileage">
								...
								<div class="overHidden">
									...
									<div class="btn-group">
                                        <% If IsUserLoginOK Then %>
										<a href="/my10x10/goodsusing.asp"><img src="//webimage.10x10.co.kr/fixevent/event/2022/118373/btn_goprd.png" alt="상품 후기 쓰러 가기"></a>
                                        <% Else %>
                            ...
                            <div class="sec-aram">
                                <img src="//webimage.10x10.co.kr/fixevent/event/2022/118373/img_alram.jpg" alt="이벤트 안내">
                                <button type="button" onclick="eventTry();"></button>
                            </div>
							<p><img src="//webimage.10x10.co.kr/fixevent/event/2022/118373/img_noti.jpg" alt="이벤트 유의사항"></p>
						</div>
