        ...
        <div class="friday-cont">
            ...
            <ul class="brand-list">
                <li>
                    ...
                    <a href="" onclick="jsDownCoupon('cLomoInstax');return false;" class="btn-coupon">LOMO&amp;INSTAX 쿠폰 받기</a>
                    <a href="/street/street_brand_sub06.asp?makerid=tnc01" class="btn-go">LOMO&amp;INSTAX 상품 보러가기</a>
                </li>
                <li>
                    <div><img src="//webimage.10x10.co.kr/fixevent/event/2019/98870/bnr_brand_2.jpg" alt="ROMANE"></div>
                    <a href="" onclick="jsDownCoupon('cRomane');return false;" class="btn-coupon">ROMANE 쿠폰 받기</a>
                    <a href="/street/street_brand_sub06.asp?makerid=romane" class="btn-go">ROMANE 상품 보러가기</a>
                </li>
                <li>
                    <div><img src="//webimage.10x10.co.kr/fixevent/event/2019/98870/bnr_brand_3.jpg" alt="XIOMI"></div>
                    <a href="" onclick="jsDownCoupon('cXiaomi');return false;" class="btn-coupon">XIOMI 쿠폰 받기</a>
                    <a href="/street/street_brand_sub06.asp?makerid=youmi10" class="btn-go">XIOMI 상품 보러가기</a>
                </li>
                <li>
                    <div><img src="//webimage.10x10.co.kr/fixevent/event/2019/98870/bnr_brand_4.jpg" alt="OA"></div>
                    <a href="" onclick="jsDownCoupon('cOa');return false;" class="btn-coupon">OA 쿠폰 받기</a>
                    <a href="/street/street_brand_sub06.asp?makerid=oa" class="btn-go">OA 상품 보러가기</a>
                </li>
            </ul>
            <%'// 브랜드 쿠폰 다운로드%>
        </div>
