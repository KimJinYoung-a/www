							...
							<div class="sorting tMar05">
								...
								<div class="option">
									<span class="badgeInfo addInfo"><strong>10x10 BADGE</strong>
										<div class="contLyr" style="width: 210px; display: none;">
							...
							<span id="lyEvalContAll">
								...
								<tbody>
									...
									<tr>
										...
										<td class="lt"><a href="javascript:" class="talkShort"><%= chkiif(eva_db2html(oEval.FItemList(i).getUsingTitle(50))="",oEval.FItemList(i).FItemname,eva_db2html(oEval.FItemList(i).getUsingTitle(50))) %></a><% if oEval.FItemList(i).IsPhotoExist then %><img src="//fiximage.10x10.co.kr/web2013/common/ico_photo.gif" alt="포토"><% End If %></td>
									...
									<tr class="talkMore" style="display: table-row;">
										<td colspan="5">
											<!-- for dev msg
											1. '전체 상품 후기 팝업과 동일한 마크업 'event/lib/popevaluateitem.asp'
											2. myItemV18 클래스 추가
											-->
											<div class="myItem myItemV18">
												<div class="pdfInfo lMar0">
													<div class="pdtPhoto"><a href="/shopping/category_prd.asp?itemid=<%=oEval.FItemList(i).FItemID%>&amp;pEtr=<%=eCode%>" target="_blank"><img src="<%=oEval.FItemList(i).FImageList120%>" width="120" height="120" alt=""></a></div>
													...
													<p class="pdtName tPad10"><a href="/shopping/category_prd.asp?itemid=<%=oEval.FItemList(i).FItemID%>&amp;pEtr=<%=eCode%>" target="_blank"><%=oEval.FItemList(i).FItemname%></a></p>
													<% end if %>
												</div>
												<div class="reviewInfo">
													...
													<div class="comment">
														...
														<div class="imgArea"><a href="javascript:popShowImg('<%=oEval.FItemList(i).getLinkImage1%>');"><img src="<%= oEval.FItemList(i).getLinkImage1 %>" alt="file1<% = i %>" /></a></div>
														<% end if %>
														<% if oEval.FItemList(i).Flinkimg2<>"" then %>
														<div class="imgArea"><a href="javascript:popShowImg('<%=oEval.FItemList(i).getLinkImage2%>');"><img src="<%= oEval.FItemList(i).getLinkImage2 %>" alt="file2<% = i %>" /></a></div>
														<% end if %>
