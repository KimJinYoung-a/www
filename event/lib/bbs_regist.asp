...
<%
strPageTitle = "텐바이텐 10X10 : 포토 코멘트 쓰기"
'#### 변수선언 #################################
...
<body>
	<div class="heightgird">
		<div class="popWrap">
			<div class="popHeader">
				<h1><img src="http://fiximage.10x10.co.kr/web2013/event/tit_photo_commnet_write.gif" alt="포토 코멘트 쓰기" /></h1>
			</div>
			<div class="popContent">
				...
				<div class="mySection">
					<fieldset>
						<legend>포토 코멘트 쓰기</legend>
						<table class="baseTable rowTable docForm tMar15">
						<caption>포토 코멘트 쓰기</caption>
						<colgroup>
						...
						<tr>
							...
							<td><input type="text" name="title" maxlength="64" id="titleSubject" class="txtInp" value="" style="width:94%;" /></td>
						</tr>
						<tr>
							<th scope="row" class="ct"><label for="commentMsg">내용</label></th>
							<td>
								<textarea id="commentMsg" name="contents" cols="60" rows="8" class="fs12" style="width:95.5%; height:188px;"></textarea>
						...
						<tr>
							...
							<td>
								...
								<p class="tMar15 fs11">파일크기는 1MB이하, JPG 또는 GIF형식의 파일만 가능합니다. 사이즈는 가로 600px 이하로 설정해 주시기 바랍니다.</p>
							</td>
						</tr>
						</tbody>
						</table>
						...
						<div class="btnArea ct tPad30">
							<input type="submit" class="btn btnS1 btnRed btnW160" value="등록하기" />
