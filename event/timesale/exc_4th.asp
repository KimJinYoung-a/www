...
'        itemNameGroups1 = Array("라인프렌즈 프로젝터", "세상 예쁜 모슈 단독 최저가", "공복을 위한 아침 특가", "겨울철 사무실 필수템", "아이패드&sol;노트북 파우치", "딱 4시간! JMW 특가", "잘 빠진 문구, 툴스투리브바이", "철가루 방지 스티커 특가", "철가루 방지 스티커 특가", "키드크래프트 5종 특가", "키드크래프트 5종 특가", "키드크래프트 5종 특가")
'        itemNameGroups2 = Array("갤럭시 버즈 화이트", "크리스마스 단독 최저가" , "겨울맞이 베베데코 특가" , "EUP 무선청소기", "수납 끝판왕 추천 특가", "변하지 않는 가치의 향" , "선물주기 딱 좋은! 귀걸이 세트", "키드크래프트 5종 특가", "키드크래프트 5종 특가", "키드크래프트 5종 특가", "키드크래프트 5종 특가", "키드크래프트 5종 특가")
'        itemNameGroups3 = Array("내셔널지오그래픽 롱패딩 (95)" , "묻고 디즈니특가로 가!" , "2020 다이어리&sol;달력", "뜨개질 DIY 키트 특가" , "청소는 미리빨,7종 특가" , "화제의 지누스 매트리스" , "락피쉬 신상품 단 4시간 타임특가!" , "강아지 건강관리 특가", "키드크래프트 5종 특가", "키드크래프트 5종 특가", "키드크래프트 5종 특가", "키드크래프트 5종 특가")
'        itemNameGroups4 = Array("에어팟 프로" , "신상 명품 가방&sol;지갑 타임특가" , "크리스마스 무드등 특가" , "스누피 와플메이커" , "묻고 디즈니특가로 가!" , "11월 산타 울리 특가" , "곤약젤리 최저가 무배" , "&lsqb;무배&rsqb; 리버시블 곰깔깔이 양털후리스", "키드크래프트 5종 특가", "키드크래프트 5종 특가", "키드크래프트 5종 특가", "키드크래프트 5종 특가")
'
...
.time-top {height:600px; background-color:#f13421; background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/99312/bg_top.jpg); background-repeat:repeat-x; background-position:50% 50%; background-size:cover;}
.time-top {position:relative;}
.time-top h2, .time-top p {position:absolute; top:110px; left:40px;}
.time-top h2:after {display:inline-block; position:absolute; top:55px; right:-30px; width:15px; height:15px; background-color:#00fffc; border-radius:50%; content:''; animation:blink .8s infinite;}
.time-top p {top:364px}

.time-sale .sale-timer {position:absolute; top:380px; left:40px; color:#fff; font-size:90px; font-weight:bold; text-align:left;}

.time-nav {display:flex; justify-content:space-between; position:absolute; top:240px; right:20px; width:485px;}
.time-nav .time {width:110px; height:113px; background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/99312/img_time1_1.png); background-repeat:no-repeat; background-position:0 0; text-indent:-999em;}
.time-nav .time2 {background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/99312/img_time1_2.png);}
.time-nav .time3 {background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/99312/img_time1_3.png);}
.time-nav .time4 {background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/99312/img_time1_4.png);}
...
.alarm .btn-alarm1 {width:327px; height:98px; background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/99312/btn_alarm1.png);}
.alarm .btn-alarm2 {width:451px; height:148px; background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/99312/btn_alarm2.png);}
.alarm .btn-alarm3 {width:578px; height:198px; background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/99312/btn_alarm3.png);}
.alarm .time-nav {position:relative; top:0; right:0; width:355px; margin-top:34px; margin-left:-15px;}
.alarm .time-nav .time {width:72px; height:79px; background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/99312/img_time2_1.png);}
.alarm .time-nav .time2 {background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/99312/img_time2_2.png);}
.alarm .time-nav .time3 {background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/99312/img_time2_3.png);}
.alarm .time-nav .time4 {background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/99312/img_time2_4.png);}
...
.time-sale .desc {padding-left:3px; margin-top:12px; color:#000; }
.time-sale .name {font-size:18px; font-weight:bold; letter-spacing:-.4px;}
...
.time-sale .price em {font-weight:bold; font-size:26px;}
.time-sale .price em span {display:inline-block; margin-left:2px; font-size:16px; font-weight:normal;}
.time-sale .price .sale {display:inline-block; margin-left:10px; color:#ff3823; font-size:26px; font-weight:bold; font-style:normal;}

.time-items ul {display:flex; flex-wrap:wrap; height:1233px; margin-top:30px; margin-bottom:35px; margin-left:-10px; margin-right:-10px;}
.time-items li {position:relative; width:250px; margin:10px;}
...
.time-items li .label {padding:1px 16px; color:#fff; font-size:16px; border-radius:15px; background-color:#222;}
...
.time-items li.rcmd-evt .desc {display:flex; align-items:center; padding-left:0;}
.time-items li.rcmd-evt .desc .price {margin-top:0;}
.time-items li.rcmd-evt .desc .price p {display:none;}
.time-items li.rcmd-evt .desc .price .sale {margin-left:5px;}
...
.coming-section .inner {width:1080px; padding-bottom:25px;}
.coming-section .alarm {padding:90px 0 55px;}
.coming-section .alarm,
.coming-section .txt-time {position:relative; z-index:20;}

.time-ing .time-items-on ul {width:1089px; margin:-105px auto 80px;}
...
.time-ing .time-items-on li.special-item .thumbnail:after {top:70px; left:50%; width:110px; height:110px; margin-left:-55px; background:url(//webimage.10x10.co.kr/fixevent/event/2019/99312/btn_buy.png);}
...
.lyr-fair .input-box1, .lyr-fair .input-box2, .lyr-fair .input-box3, .lyr-fair .input-box4, .lyr-fair .btn-get1, .lyr-fair .btn-get2, .lyr-fair .btn-get3, .lyr-fair .btn-get4 {position:absolute; top:437px; left:80px;}
.lyr-fair #notRobot1, .lyr-fair #notRobot2, .lyr-fair #notRobot3, .lyr-fair #notRobot4 {display:none;}
.lyr-fair #notRobot1 + label, .lyr-fair #notRobot2 + label, .lyr-fair #notRobot3 + label, .lyr-fair #notRobot4 + label {display:inline-block; width:250px; height:33px; background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/99312/txt_chck.png); text-indent:-999em; cursor:pointer;}
.lyr-fair #notRobot:checked + label, .lyr-fair #notRobot2:checked + label, .lyr-fair #notRobot3:checked + label, .lyr-fair #notRobot4:checked + label {background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/99312/txt_chck_on.png);}
...
.lyr-alarm .input-box {position:absolute; top:570px; left:75px; display:flex; justify-content:space-between; align-items:center; width:283px; color:#00c6ff; font-weight:bold;}
.lyr-alarm .input-box input {width:33%; height:45px; padding:0; margin:0 5px; background-color:transparent; border:0; border-bottom:solid 3px #00fffc; border-radius:0; color:#cbcbcb; font-size:22px; line-height:1; font-weight:bold; text-align:center;}
.lyr-alarm .input-box input:first-child {margin-left:0;}
.lyr-alarm .input-box .btn-submit {width:80px; margin-left:10px; color:#00c6ff; font-size:22px; font-weight:bold;}
...
.lyr-end .time-items li:before {display:inline-block; position:absolute; top:100px; left:50%; z-index:20; width:80px; height:auto; margin-left:-40px; color:#fff; font-size:18px; line-height:1.5; content:'순식간에 판매완료'; text-align:center;}
...
.related-evt {background:url(//webimage.10x10.co.kr/fixevent/event/2019/99312/bg_related.jpg) no-repeat 50% 50%/cover;}
...
<script>
    ...
    $(function() {
        ...
        //미끼상품
        $('.time-items ul li:nth-child(1)').addClass('special-item');
        $('.time-items ul li:nth-child(9), .time-items ul li:nth-child(12)').addClass('rcmd-evt');
...
<% end if %>
    ...
    <div class="lyr lyr-end" style="display:none;">
        <div class="inner">
            ...
            <div class="time-items" style="display:none;">
                <p class="txt-time"><img src="//webimage.10x10.co.kr/fixevent/event/2019/99312/tit_time2_<%=oTimeSale.FitemList(loopInt).Fround%>.png" alt="<%=oTimeSale.FitemList(loopInt).Fround%>회 세일"></p>
                <ul>
            <%
                    END IF
            %>
    ...
    <div class="lyr lyr-alarm" style="display:none;">
        <div class="inner">
            <p><img src="//webimage.10x10.co.kr/fixevent/event/2019/99312/txt_push.png" alt="기회를 놓치지 않는 가장 확실한 방법"></p>
    ...
    <div class="related-evt">
        <img src="//webimage.10x10.co.kr/fixevent/event/2019/99312/img_related_evt.jpg" alt="잠깐 찬스, 하나더 아니, 세개 더" usemap="#evt-map">
        <map name="evt-map">
            <area target="blank_" alt="지금부터 준비하세요! 크리스마스 소품의 모든 것" href="/christmas/" coords="327,84,548,392" shape="rect" onclick="fnAmplitudeEventMultiPropertiesAction('click_timesale_bnr','idx|evtcode','1|cirsmas')" onfocus="this.blur();">
            <area target="blank_" alt="지금 텐바이텐에서  가장 인기 많은 BEST 20" href="/event/eventmain.asp?eventid=99242" coords="591,85,814,386" shape="rect" onclick="fnAmplitudeEventMultiPropertiesAction('click_timesale_bnr','idx|evtcode','2|99242')" onfocus="this.blur();">
            <area target="blank_" alt="텐바이텐이 처음이세요? 그럼 이 상품 꼭! 추천합니다" href="/event/eventmain.asp?eventid=99222" coords="856,86,1081,387" shape="rect" onclick="fnAmplitudeEventMultiPropertiesAction('click_timesale_bnr','idx|evtcode','3|99222')" onfocus="this.blur();">
        </map>
    </div>
</div>
