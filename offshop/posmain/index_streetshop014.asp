...
<body marginwidth = "0" marginheight = "0" leftmargin = "0" topmargin = "0"><script language="javascript">FlashEmbed("street_index","posswf.swf",660,587,"?streeturl=/offshop/flash/point1010mainflash_436.txt");</script>
</body>
</html>
