...
<body marginwidth = "0" marginheight = "0" leftmargin = "0" topmargin = "0"><script language="javascript">FlashEmbed("ithinkso_index","posswf.swf",900,800,"?streeturl=/offshop/flash/point1010mainflash_432.txt");</script>
</body>
</html>
