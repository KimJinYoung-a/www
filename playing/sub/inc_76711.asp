...
snpLink1 = Server.URLEncode("http://www.10x10.co.kr/event/76810")
snpLink2 = Server.URLEncode("http://www.10x10.co.kr/event/76811")
snpLink3 = Server.URLEncode("http://www.10x10.co.kr/event/76812")
snpLink4 = Server.URLEncode("http://www.10x10.co.kr/event/76813")
snpLink5 = Server.URLEncode("http://www.10x10.co.kr/event/76814")
%>
...
.prescription .result {position:relative; width:855px; height:930px; margin:0 auto; background:url(http://webimage.10x10.co.kr/playing/thing/vol010/bg_paper_v2.png) 0 0 no-repeat;}
.prescription .result h3 {padding:120px 0 34px;}
.prescription .result .btnAgain {position:absolute; left:185px; bottom:55px;}
.prescription .result .btnShare {position:absolute; right:185px; bottom:55px;}
.prescription .result .inner {position:relative; height:680px;}
.prescription .result .inner .btnGo {display:inline-block; position:absolute; left:50%; bottom:22px; margin-left:-18px;}
...
.heartSeed .kit {padding:112px 0 105px; background:#1f9d62;}
.heartSeed .kit .total {padding-top:20px; font-size:13px; font-weight:bold; color:#000;}
...
%>
	...
	<% Else %>
		...
		if (str1[0] == "05"){
			alert('응모가 완료 되었습니다!');
			$("#vImage").attr("src","http://webimage.10x10.co.kr/playing/thing/vol010/btn_kit_finish.png"); 
		}else if(str1[0] == "03"){
			alert('이미 응모하였습니다.!');
		} else {
			alert('오류가 발생했습니다.');
...
<% If IsUserLoginOK() Then %>
	...
	str = $.ajax({
		type: "POST",
		url: "/playing/sub/doEventSubscript76711.asp?mode=snsresult",
		data: $("#sfrm").serialize(),
		dataType: "text",
		async: false
	}).responseText;
...
<input type="hidden" name="tmpex5" id="tmpex5">
	<div class="intro">
		...
		<button type="button" class="btnStart" onclick="jsChklogin('<%=IsUserLoginOK%>');return false;"><img src="http://webimage.10x10.co.kr/playing/thing/vol010/btn_start.png" alt="증상 체크하기" /></button>
	</div>
		...
		<div class="inner">
			...
			<div class="question question4" id="Q4">
				...
				<ul>
					...
					<li onclick="jsplayingthing('5','4'); return false;"><i></i><img src="http://webimage.10x10.co.kr/playing/thing/vol010/btn_face_2.png" alt="" /></li>
					...
					<li onclick="jsplayingthing('2','4'); return false;"><i></i><img src="http://webimage.10x10.co.kr/playing/thing/vol010/btn_face_5.png" alt="" /></li>
	...
	<div id="kit" class="kit">
		...
		<button type="button" class="btnKit" onclick="jsplayingthingadd('2'); return false;">
			<img id="vImage" src="http://webimage.10x10.co.kr/playing/thing/vol010/<%=Chkiif(myresultCnt =0, "btn_kit", "btn_kit_finish")%>.png" alt="씨앗 키트 신청하기" />
		</button>
