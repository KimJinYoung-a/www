			...
			<div class="csContent">
				...
				<div class="content">
					...
					<div class="articleSection">
						...
						<h5 id="agreen6-3">제 23조 (Gift카드)</h5>
						...
						<h5 id="agreen6-5">제 25조 (보너스쿠폰)</h5>
						...
						<div class="btnTop"><a href="#agree"><img src="http://fiximage.10x10.co.kr/web2013/cscenter/btn_top.gif" alt="TOP" /></a></div>
						<h5>부칙(2016.5.27)<h5>
						<p>2016년 6월 7일부터 적용됩니다. <a href="join.asp" style="text-decoration:underline; padding-left:5px;">개정 후 서비스 약관보기</a></p>
					</div>
				</div>
				<!-- //content -->
