...
<p>개인정보처리방침은 2016년 09월 12일부터 적용됩니다. 내용의 추가, 삭제 및 수정이 있을 시에는 개정 최소 7일전부터 홈페이지의 공지사항을 통하여 고지할 것입니다. 또한 개인정보처리방침에 버전번호 및 개정일자 등을 부여하여 개정여부를 쉽게 알 수 있도록 하고 있습니다</p>
<ul class="tPad20">
	...
	<li>- 개인정보처리방침 버전번호 : v20150724 &nbsp;&nbsp;<a href="/common/private_v20150724.asp" class="linkBtn" target="_blank"><strong>이전버전보기</strong></a></li><!-- 시행날짜 기준으로 해당버전 생성관리 -->
	<li class="tMar10">- 개인정보처리방침 버전번호 : v20160912</li>
	<li>- 개인정보처리방침 변경공고일자 : 2016년 9월 5일</li>
	<li>- 개인정보처리방침 시행일자 : 2016년 9월 12일</li>
</ul>
<div class="btnTop"><a href="#individual"><img src="http://fiximage.10x10.co.kr/web2013/cscenter/btn_top.gif" alt="TOP" /></a></div>