...
<ul>
	<li>
		...
		<div class="boardList indi2Board tPad20 bPad10">
		<table>
		...
		<tr>
		<td rowspan="4">주문 상품 <br/>무통장 환불시</td>
		<td class="exptSt">필수여부</td>
		<td>선택</td>
		</tr>
		<tr>
		...
		<tr>
		<td rowspan="4">마케팅 및 분석<br/>(기획전, 이벤트,<br/>프로모션 포함)</td>
		<td class="exptSt">필수여부</td>
		<td>선택</td>
		</tr>
		<tr>
		...
		<tr>
		<td rowspan="4">해외통관 <br/>상품 구매(해외직구)</td>
		<td class="exptSt">필수여부</td>
		<td>선택</td>
		</tr>
		<tr>
		...
		<tr>
		<td rowspan="2">서비스 이용시 <br/ >생성되어 수집되는 정보<br/ ></td>
...
<div class="boardList tPad20 bPad10">
	...
	<tbody>
	<tr>
	<td>㈜케이지이니시스, NHN한국사이버결제㈜, LG U+,<br/ > 네이버㈜, ㈜LG CNS</td>
	...
	<tr>
	<td>입점업체 (<a href="http://webimage.10x10.co.kr/partner/cooper/cooperate_2017050035261423321.pdf" target="_blank">상세내역</a>)</td>
	<td>주문 상품의 배송</td>
	</tr>
	<tr>
		<td>braze Inc.</td>
...
<ul class="tPad20">
	...
	<li>- 개인정보처리방침 버전번호 : v20171001 &nbsp;&nbsp;<a href="/common/private_v20171001.asp" class="linkBtn" target="_blank"><strong>이전버전보기</strong></a></li><!-- 시행날짜 기준으로 해당버전 생성관리 -->
	<li class="tMar10">- 개인정보처리방침 버전번호 : v20171207</li>
	<li>- 개인정보처리방침 변경공고일자 : 2017년 11월 30일</li>
	<li>- 개인정보처리방침 시행일자 : 2017년 12월 07일</li>
</ul>
<div class="btnTop"><a href="#individual"><img src="http://fiximage.10x10.co.kr/web2013/cscenter/btn_top.gif" alt="TOP" /></a></div>
