				...
				<div class="popReviewV15">
					...
					%>
						<div class="generalReviewV15">
							<h4>&lt;<span>총평 <img src="//fiximage.10x10.co.kr/web2019/common/ico_review_star_0<%=cInt(vFdEvalTT)%>.png" alt="별<%=cInt(vFdEvalTT)%>개" /> <%=cInt(vFdEvalTT*20)%>점</span>&gt;</h4>
							<ul>
								<li>
									<strong>기능</strong>
									<p><img src="//fiximage.10x10.co.kr/web2019/common/ico_review_star_0<%=cInt(vFdEvalFun)%>.png" alt="별<%=cInt(vFdEvalFun)%>개" /> <%=cInt(vFdEvalFun*20)%>점</p>
								</li>
								<li>
									<strong>디자인</strong>
									<p><img src="//fiximage.10x10.co.kr/web2019/common/ico_review_star_0<%=cInt(vFdEvalDgn)%>.png" alt="별<%=cInt(vFdEvalDgn)%>개" /> <%=cInt(vFdEvalDgn*20)%>점</p>
								</li>
								<li>
									<strong>가격</strong>
									<p><img src="//fiximage.10x10.co.kr/web2019/common/ico_review_star_0<%=cInt(vFdEvalPrc)%>.png" alt="별<%=cInt(vFdEvalPrc)%>개" /> <%=cInt(vFdEvalPrc*20)%>점</p>
								</li>
								<li>
									<strong>만족도</strong>
									<p><img src="//fiximage.10x10.co.kr/web2019/common/ico_review_star_0<%=cInt(vFdEvalStf)%>.png" alt="별<%=cInt(vFdEvalStf)%>개" /> <%=cInt(vFdEvalStf*20)%>점</p>
								</li>
							</ul>
