			...
			<div class="csContent">
				...
				<div class="content">
					...
					<div class="articleSection">
						...
						<p>이 약관은 텐바이텐주식회사(이하 "회사") 가 운영하는 인터넷 사이트를 통하여 제공하는 전자상거래 관련 서비스(이하 "서비스")를 이용함에 있어 회사와 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.<br/> * PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.</p>
						...
						<div class="btnTop"><a href="#agree"><img src="http://fiximage.10x10.co.kr/web2013/cscenter/btn_top.gif" alt="TOP" /></a></div>
						<h5>부칙(2016.5.27)</h5>
						<p>2016년 6월 7일부터 적용됩니다. <a href="join_prev_v20150615.asp" style="text-decoration:underline; padding-left:5px;">이전약관 보기</a> <a href="join.asp" style="text-decoration:underline; padding-left:5px;">개정 후 서비스 약관보기</a></p>
					</div>
				</div>
				<!-- //content -->
