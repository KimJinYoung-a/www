...
'// 페이지 타이틀 및 페이지 설명 작성
strPageTitle = "텐바이텐 10X10 : 개인정보 처리방침"		'페이지 타이틀 (필수)
strPageDesc = ""		'페이지 설명
	...
	<div class="container">
		<div id="contentWrap">
			<div class="csContent">
				...
				<!-- content -->
				<div class="content">
					<h3 id="individual" class="line"><img src="http://fiximage.10x10.co.kr/web2013/common/tit_individual_information.gif" alt="개인정보 처리방침" /></h3>
					<div class="anchorNav">
						<ul class="tPad30">
					...
					<div class="articleSection">
						<!-- #include virtual="/common/privateCont_v20160912.asp" -->
					</div>
				</div>
				<!-- //content -->
