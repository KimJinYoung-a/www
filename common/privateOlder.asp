		...
		<div id="contentWrap">
			<div class="csContent">
				...
				<div class="content">
					...
					<div class="anchorNav">
						<p>고객의 기본적인 사생활 비밀과 자유 및 통신 비밀을 보장하고, 불법적인 도청, 정보유출로 인한 인권 피해가 발생하지 않도록 하고자 마련한 것입니다. 텐바이텐의 개인정보 취급방침은 다음과 같은 내용을 담고있습니다.</p>
						<ul>
					...
					<div class="articleSection">
						...
						<ul>
							<li>- 텐바이텐은 귀하께서 텐바이텐의 개인정보취급방침 및 이용약관의 내용에 대해 「동의한다」버튼 또는 「동의하지 않는다」버튼을 클릭할 수 있는 절차를 마련하여, 「동의한다」버튼을 클릭하면 개인정보 수집에 대해 동의한 것으로 봅니다.</li>
						</ul>
						...
						<p>1. 쿠키(cookie)란?<br /> 텐바이텐은 귀하에 대한 정보를 저장하고 수시로 찾아내는 쿠키(cookie)를 사용합니다. 쿠키는 웹사이트가 귀하의 컴퓨터 브라우저(넷스케이프, 인터넷익스플로러 등)로 전송하는 소량의 정보입니다. 귀하께서 웹사이트에 접속을 하면 텐바이텐의 서버는 귀하의 브라우저에 추가정보를 임시로 저장하여 접속에 따른 성명 등의 추가 입력 없이 텐바이텐의 서비스를 제공할 수 있습니다. 쿠키는 귀하의 컴퓨터는 식별하지만 귀하를 개인적으로 식별하지는 않습니다. 또한 귀하는 쿠키에 대한 선택권이 있습니다.</p>
						<p>2. 텐바이텐의 쿠키 운용<br /> 텐바이텐은 이용자의 편의를 위하여 쿠키를 운영합니다. 텐바이텐이 쿠키를 통해 수집하는 정보는 회원ID에 한하며, 그 외의 다른 정보는 수집하지 않습니다. 텐바이텐이 쿠키를 통해 수집한 회원 ID는 다음의 목적을 위해 사용됩니다.</p>
						<ul>
							<li>① 개인의 관심 분야에 따란 차별화된 정보를 제공 </li>
							<li>② 쇼핑한 품목들에 대한 정보와 장바구니 서비스를 제공 </li>
							<li>③ 회원과 비회원의 접속빈도 또는 머문 시간 등을 분석하여 서비스 개편 및 마케팅에 활용</li>
						</ul>
						<p>3. 쿠키는 브라우저의 종료시나 로그아웃 시 만료됩니다.</p>
						<p>4. 쿠키의 설치 및 거부</p>
						<ul>
						...
						<ul>
							...
							<li>- 소속: 시스템팀</li>
							<li>- 직책: 팀장</li>
							<li>- 이메일: <a href="mailto:eastone@10x10.co.kr">eastone@10x10.co.kr</a></li>
						...
						<p>개인정보처리방침은 2011년 11월 04일부터 적용됩니다. 내용의 추가, 삭제 및 수정이 있을 시에는 개정 최소 7일전부터 홈페이지의 공지사항을 통하여 고지할 것입니다. 또한 개인정보처리방침에 버전번호 및 개정일자 등을 부여하여 개정여부를 쉽게 알 수 있도록 하고 있습니다.</p>
						<ul class="tPad20">
							<li>- 개인정보처리방침 버전번호 : v20111104- 개인정보처리방침 변경공고일자 : 2011년 10월 28일</li>
							<li>- 개인정보처리 시행일자 : 2011년 11월 04일</li>
						</ul>
						<div class="btnTop"><a href="#individual"><img src="http://fiximage.10x10.co.kr/web2013/cscenter/btn_top.gif" alt="TOP" /></a></div>
					</div>
				</div>
