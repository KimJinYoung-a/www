...
class cdiary_list
	...
	public Sub getDiaryAwardBest()
		...
		dim rsMem : set rsMem = getDBCacheSQL(dbget,rsget,"DIAW",sqlStr,60*3)
    ...
    public Sub DiaryStoryProdCheck()
		...
		sqlStr = " EXECUTE [db_diary2010].[dbo].[usp_WWW_DiaryStory_BadgeItem_Get] '" & FItemID & "' "
		rsget.CursorLocation = adUseClient
		rsget.CursorType = adOpenStatic
		rsget.LockType = adLockOptimistic
		'response.write sqlStr & "<br>"
...
'		sqlStr = sqlStr & " 			and A.gift_status=7 " +vbcrlf
	...
	Public Sub getOneplusOneDaily()
		...
		sqlStr = sqlStr & " , o.itemid, o.image1, o.image2, o.imageend, o.endlink, o.explain, o.plustype, o.topimage1, o.topimage2, o.topimage3, o.colorcodeleft, o.colorcoderight"
		...
		sqlStr = sqlStr & " where convert(varchar(10),o.startdate ,120) <= convert(varchar(10),getdate(),120) "
...
Function getDiaryEventMainImg(pcode)
	...
	strSQL = " Select top 1 imagepath, linkpath, B.colorcodeleft, B.colorcoderight From db_diary2010.dbo.tbl_diary_poscode A "
	...
	rsget.Open strSQL, dbget, 1
	If Not rsget.EOF Then
		getDiaryEventMainImg = rsget("imagepath")&"|"&rsget("linkpath")&"|"&rsget("colorcodeleft")&"|"&rsget("colorcoderight")
	Else
