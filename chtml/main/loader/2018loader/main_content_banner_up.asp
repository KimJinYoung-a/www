...
<%
'#######################################################
' Discription : pc_main_content_banner_up // cache DB경유
' History : 2019-02-15 원승현 생성
'#######################################################
Dim intI
Dim sqlStr , rsMem , arrList, poscode
Dim gaParam : gaParam = "gaparam=main_content_banner_up_" '//GA 체크 변수

'//DB 시간 타이머 00시부터 00시 5분 사이에는 DB 캐쉬 1분에 한번 읽기
Dim cTime , dummyName
If timer > 10 And Cint(timer/60) < 6 Then
	cTime = 60*1
	dummyName = "MBCUBAN_"&Cint(timer/60)
Else
	cTime = 60*1
	dummyName = "MBCUBAN"
End If

'// 메인 컨텐츠 상단 배너(poscode)
poscode = "722"
