...
Dim fnGetList, r
    ...
    If CInt(vImageCount) >= CInt(vTotalCount) Then
		...
		For i = 1 to vTotalCount
			BufStr = BufStr + VarName + "+=" + DoubleQuat + "<div class='swiper-slide' style='cursor:pointer;' onclick=location.href='"& wwwUrl & db2Html(fnGetList(1,i-1)) &"&gaparam=street_lookbook_"&i&"'>" + DoubleQuat + VbCrlf
