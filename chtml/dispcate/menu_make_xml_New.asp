...
<%
	...
	'####### Top 메뉴 생성.
	If Trim(vCateCode) = "124" Then
		iBuf = ""
		iBuf = iBuf & "<div class='gnb-sub' id='gnb124'>" & vbCrLf
'		iBuf = iBuf & "	<div class='gnbCtgyGroupV15'>" & vbCrLf
		iBuf = iBuf & "		<div class='dept-unit'>" & vbCrLf
		iBuf = iBuf & "			<dl>" & vbCrLf
		iBuf = iBuf & "				<dt><p><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124114'>브랜드관</a></p></dt>" & vbCrLf
		iBuf = iBuf & "				<dd>" & vbCrLf
		iBuf = iBuf & "					<ul class='list-depth'>" & vbCrLf
		iBuf = iBuf & "						<li><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124114101'>발뮤다</a></li>" & vbCrLf
		iBuf = iBuf & "						<li><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124114102'>다이슨</a></li>" & vbCrLf
		iBuf = iBuf & "						<li><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124114103'>플러스마이너스제로</a></li>" & vbCrLf
		iBuf = iBuf & "						<li><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124114104'>스메그</a></li>" & vbCrLf
		iBuf = iBuf & "						<li><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124114107'>레꼴뜨</a></li>" & vbCrLf
		iBuf = iBuf & "						<li><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124114111'>라쿠진</a></li>" & vbCrLf
		iBuf = iBuf & "						<li><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124114112'>쿠쿠</a></li>" & vbCrLf
		iBuf = iBuf & "						<li><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124114119'>제니퍼룸</a></li>" & vbCrLf
		iBuf = iBuf & "						<li><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124114115'>쿠진아트 <span class='icoV18 ico-new'>N</span></a></li>" & vbCrLf
		iBuf = iBuf & "						<li><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124114114'>네스프레소 <span class='icoV18 ico-new'>N</span></a></li>" & vbCrLf
		iBuf = iBuf & "					</ul>" & vbCrLf
		iBuf = iBuf & "					<a href='" & SSLUrl & "/shopping/category_list.asp?disp=124114' class='btn-linkV18 link3'>more <span></span></a>" & vbCrLf
		iBuf = iBuf & "				</dd>" & vbCrLf
		iBuf = iBuf & "			</dl>" & vbCrLf
		iBuf = iBuf & "		</div>" & vbCrLf
		iBuf = iBuf & "		<div class='dept-unit'>" & vbCrLf
		iBuf = iBuf & "			<dl>" & vbCrLf
		iBuf = iBuf & "				<dt><p><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124101'>시즌가전</a></p></dt>" & vbCrLf
		iBuf = iBuf & "				<dd>" & vbCrLf
		iBuf = iBuf & "					<ul class='list-depth'>" & vbCrLf
		iBuf = iBuf & "						<li><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124101'>여름가전 <span class='icoV18 ico-hot' id='tophotdisp125102101'>H</span></a></li>" & vbCrLf
		iBuf = iBuf & "						<li><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124112'>겨울가전</a></li>" & vbCrLf
		iBuf = iBuf & "					</ul>" & vbCrLf
		iBuf = iBuf & "				</dd>" & vbCrLf
		iBuf = iBuf & "			</dl>" & vbCrLf
		iBuf = iBuf & "		</div>" & vbCrLf
		iBuf = iBuf & "		<div class='dept-unit'>" & vbCrLf
		iBuf = iBuf & "			<dl>" & vbCrLf
		iBuf = iBuf & "				<dt><p><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124103'>주방가전</a></p></dt>" & vbCrLf
		iBuf = iBuf & "				<dd>" & vbCrLf
		iBuf = iBuf & "					<ul class='list-depth'>" & vbCrLf
		iBuf = iBuf & "						<li><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124103'>믹서기/블렌더 <span class='icoV18 ico-new' style='display:none;'>N</span></a></li>" & vbCrLf
		iBuf = iBuf & "						<li><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124106'>오븐/토스터</a></li>" & vbCrLf
		iBuf = iBuf & "						<li><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124107'>전기주전자</a></li>" & vbCrLf
		iBuf = iBuf & "						<li><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124108'>밥솥/쿠커/메이커</a></li>" & vbCrLf
		iBuf = iBuf & "						<li><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124104'>빙수기/냉장고</a></li>" & vbCrLf
		iBuf = iBuf & "						<li><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124109'>그릴/전기렌지</a></li>" & vbCrLf
		iBuf = iBuf & "					</ul>" & vbCrLf
		iBuf = iBuf & "				</dd>" & vbCrLf
		iBuf = iBuf & "			</dl>" & vbCrLf
		iBuf = iBuf & "		</div>" & vbCrLf
		iBuf = iBuf & "		<div class='dept-unit'>" & vbCrLf
		iBuf = iBuf & "			<dl>" & vbCrLf
		iBuf = iBuf & "				<dt><p><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124111'>생활가전</a></p></dt>" & vbCrLf
		iBuf = iBuf & "				<dd>" & vbCrLf
		iBuf = iBuf & "					<ul class='list-depth'>" & vbCrLf
		iBuf = iBuf & "						<li><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124102'>공기청정기 <span class='icoV18 ico-hot' style='display:none;' id='tophotdisp125104101'>H</span></a></li>" & vbCrLf
		iBuf = iBuf & "						<li><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124105'>청소기</a></li>" & vbCrLf
		iBuf = iBuf & "						<li><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124110101'>제습기</a></li>" & vbCrLf
		iBuf = iBuf & "						<li><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124110102'>가습기</a></li>" & vbCrLf
		iBuf = iBuf & "						<li><a href='" & SSLUrl & "/shopping/category_list.asp?disp=124111'>생활가전</a></li>" & vbCrLf
		iBuf = iBuf & "					</ul>" & vbCrLf
		iBuf = iBuf & "				</dd>" & vbCrLf
		iBuf = iBuf & "			</dl>" & vbCrLf
		iBuf = iBuf & "		</div>" & vbCrLf
		iBuf = iBuf & "		<div class='dept-unit dept-unit-top'>" & vbCrLf
		iBuf = iBuf & "			<ul class='list-depth'>" & vbCrLf
		iBuf = iBuf & "				<li><p><a href='" & SSLUrl & "/shoppingtoday/shoppingchance_saleitem.asp?disp=124' class='color-red'><b>SALE</b></a></p></li>" & vbCrLf
		iBuf = iBuf & "				<li><p><a href='" & SSLUrl & "/shoppingtoday/shoppingchance_allevent.asp?disp=124' class='color-blue'><b>EVENT</b></a></p></li>" & vbCrLf
		iBuf = iBuf & "			</ul>" & vbCrLf
		iBuf = iBuf & "		</div>" & vbCrLf
'		iBuf = iBuf & "	</div>" & vbCrLf
...
'		iBuf = iBuf & "	</div>" & vbCrLf
	...
	Else
		iBuf = ""
		iBuf = iBuf & "<div class='gnb-sub' id='gnb" & vCateCode & "'>" & vbCrLf
'		iBuf = iBuf & "	<div class='gnbCtgyGroupV15'>" & vbCrLf
...
'// 20200305 - BOOK 모음 메뉴 더이상 사용안하는듯 생성 제거
'	'####### BOOK Left 메뉴 생성.
	...
	vCnt2 = 0
		...
		For i = 0 To UBound(arr,2)
			...
			If i < 4 Then
				...
				vBody = vBody & "		<div class='dept-unit'>" & vbCrLf
				vBody = vBody & "			<dl>" & vbCrLf
				vBody = vBody & "				<dt><p><a href='" & SSLUrl & "/shopping/category_list.asp?disp="&arr(0,i)&"'>" & chrbyte(Replace(arr(1,i),"&","&amp;"),14,"Y") & " <span class='icoV18 ico-hot' style='display:none;' id='tophotdisp"&arr(0,i)&"'> H</span> <span class='icoV18 ico-new' " & CHKIIF(arr(2,i)="o","","style='display:none;'") & ">N</span></a></p></dt>" & vbCrLf
				vBody = vBody & "				<dd>" & vbCrLf
				vBody = vBody & "					<ul class='list-depth'>" & vbCrLf
				
				For j = 0 To UBound(vArray,2)
					If j < 10 Then
						vBody = vBody & "						<li><a href='" & SSLUrl & "/shopping/category_list.asp?disp="&vArray(0,j)&"'>" & chrbyte(Replace(vArray(1,j),"&","&amp;"), 11, "Y") & " <span class='icoV18 ico-hot' style='display:none;' id='tophotdisp"&vArray(0,j)&"'>H</span> <span class='icoV18 ico-new' " & CHKIIF(vArray(2,j)="o","","style='display:none;'") & ">N</span></a></li>" & vbCrLf
					End If
				Next
				
				vBody = vBody & "					</ul>" & vbCrLf
				If v3DepCount > 10 Then
					vBody = vBody & "				<a href='" & SSLUrl & "/shopping/category_list.asp?disp="&arr(0,i)&"' class='btn-linkV18 link3'>more <span></span></a>" & vbCrLf
				End If
				vBody = vBody & "				</dd>" & vbCrLf
				vBody = vBody & "			</dl>" & vbCrLf
			...
			If i >= 4 AND i < 14 Then
				...
				If i = 4 Then
				vBody = vBody & "		<div class='dept-unit dept-unit-top'>" & vbCrLf
				vBody = vBody & "			<ul class='list-depth'>" & vbCrLf
				End If
				vBody = vBody & "				<li><p><a href='" & SSLUrl & "/shopping/category_list.asp?disp="&arr(0,i)&"'><b>" & chrbyte(Replace(arr(1,i),"&","&amp;"), 15, "Y") & " <span class='icoV18 ico-hot' style='display:none;' id='tophotdisp"&arr(0,i)&"'>H</span> <span class='icoV18 ico-new' " & CHKIIF(arr(2,i)="o","","style='display:none;'") & ">N</span></b></a></p>" & vbCrLf
...
'					For j = 0 To UBound(vArray,2)
'						If j < 10 Then
'							vBody = vBody & "							<li><a href='" & SSLUrl & "/shopping/category_list.asp?disp="&vArray(0,j)&"'>" & Replace(vArray(1,j),"&","&amp;") & "<span class='icoHot' style='display:none;' id='tophotdisp"&vArray(0,j)&"'> <img src='http://fiximage.10x10.co.kr/web2013/common/ico_hot.gif' alt='HOT' /></span><span class='icoNew' " & CHKIIF(vArray(2,j)="o","","style='display:none;'") & "> <img src='http://fiximage.10x10.co.kr/web2013/common/ico_new2.gif' alt='New' /></span></a></li>" & vbCrLf
'						End If
'					Next

'					vBody = vBody & "							</ul>" & vbCrLf
'					If v3DepCount > 10 Then
'					vBody = vBody & "							<span class='gnbMoreV15'><a href='" & SSLUrl & "/shopping/category_list.asp?disp="&arr(0,i)&"'>more</a> &gt;</span>" & vbCrLf
'					End If
'					vBody = vBody & "						</div>" & vbCrLf
'					vBody = vBody & "					</div>" & vbCrLf
...
'				End If
			...
			If i = UBound(arr,2) OR i = 13 Then
				vBody = vBody & "				<li><p><a href='" & SSLUrl & "/shoppingtoday/shoppingchance_saleitem.asp?disp="&arr(0,i)&"' class='color-red'><b>SALE</b></a></p></li>" & vbCrLf
				vBody = vBody & "				<li><p><a href='" & SSLUrl & "/shoppingtoday/shoppingchance_allevent.asp?disp="&arr(0,i)&"' class='color-blue'><b>EVENT</b></a></p></li>" & vbCrLf
				vBody = vBody & "			</ul>" & vbCrLf
				vBody = vBody & "		</div>" & vbCrLf
				Exit For
			End If
