...
'		End IF
		...
		vBody = vBody & "							<a href=""" & rsget("evt_link") & CateMain_GaParam(vCateCode,"specialevent",i) &""" onclick=""fnAmplitudeEventMultiPropertiesAction('click_category_main_specialevent','indexnumber|eventcode','"& i &"|"& rsget("evt_code") &"');"">" & vbCrLf
