...
<div class="diary-header">
	<div class="inner">
		<h2><a href="/diarystory2021/">텐텐문구점</a></h2>
		<ul class="diary-menu">
			<li class="<%=chkiif(instr(request.ServerVariables("SCRIPT_NAME"),"index.asp") > 0,"on","")%>"><a href="/diarystory2021/" onclick="fnAmplitudeEventAction('click_diary_gnbmenu','gnb_name','home');">홈</a></li>
			<li class="<%=chkiif(instr(request.ServerVariables("SCRIPT_NAME"),"exhibition.asp") > 0,"on","")%>"><a href="/diarystory2021/exhibition.asp" onclick="fnAmplitudeEventAction('click_diary_gnbmenu','gnb_name','diaryevent');">기획전</a></li>
