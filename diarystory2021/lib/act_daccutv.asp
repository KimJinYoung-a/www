...
%>
<article class="dr-tv-item">
	<figure class="dr-tv-img"><img src="<%=oTenfluencer.FItemList(i).Fmainimage%>" alt=""></figure>
	<div class="dr-tv-info">
		<p class="dr-tv-brand"><%=oTenfluencer.FItemList(i).Fctitle%></p>
		<p class="dr-tv-name"><%=oTenfluencer.FItemList(i).Fgroupname%></p>
	</div>
	...
	<a href="javascript:goDetail('<%=oTenfluencer.FItemList(i).Fcidx%>');" class="dr-tv-link"><span class="blind">이벤트바로가기</span></a>
</article>
<%
        End if
    Next
