...
<%
	...
	dim returnScriptName , returnScriptFormName
...
'	end if
	...
	if refip="121.78.103.60" then
		response.write mysns & "<br>"
		response.write mysnsgb & "<br>"
		response.write snsbackpath & "<br>"
		response.write snsjoingubun & "<br>"
		response.write itemid & "<br>"
		response.write returnScriptName & "<br>"
		response.write returnScriptFormName & "<br>"
		'response.end
	end if
