...
Dim fnGetList
    ...
    If CInt(vImageCount) >= CInt(vTotalCount) Then
		...
		For i = 1 to vTotalCount
			BufStr = BufStr + VarName + "+=" + DoubleQuat + "	<a href='"& wwwUrl & db2Html(fnGetList(1,i-1)) &"'><img src='" & staticImgUrl & "/brandstreet/main/" & db2Html(fnGetList(0,i-1)) &"' alt='rollingIMG"&i&"' /></a>" + DoubleQuat + VbCrlf
		Next
