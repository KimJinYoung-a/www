...
Dim image, image2, link, linktext, linktext2, startdate, enddate, linktext3, linktext4
	...
	mainFile = "mainXMLBanner_688.xml"
...
If fileCont<>"" Then
	...
	For each tplNodes in cTmpl
		...
		if i>2 then exit for	'//최대 3개까지 제한
		...
		linktext3	= tplNodes.getElementsByTagName("linktext3").item(0).text			'하단 상품설명
		linktext4	= tplNodes.getElementsByTagName("linktext4").item(0).text			'할인율
