...
<script>
    ...
    function daccuTokTokImageExec() {
        $.ajax({
            type:"POST",
            url:"/diarystory2020/lib/ajaxDaccuTokTok.asp",
    ...
    function daccuTokTokDetailProduct() {
        $.ajax({
            type:"GET",
            url:"/diarystory2020/lib/act_daccu_toktok_detailitemlist.asp?MasterIdx="+$('#daccuTokMasterIdx').val(),
            //data: ,
            dataType: "text",
            async:false,
            cache:true,
    ...
    function daccuMyOrderList() {
	    <% If IsUserLoginOK() Then %>
            ...
            $.ajax({
                type:"GET",
                url:"/diarystory2020/lib/act_daccu_toktok_myorder.asp",
