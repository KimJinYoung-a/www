						...
						<div class="myWishWrap">
							<div class="sorting bPad30">
								<ul class="tabMenu addArrow tabReview">
									...
									<li><a href="?EvaluatedYN=Y" <%= ChkIIF(EvaluatedYN="Y","class='on'","") %> ><span>상품후기 수정/보기</span></a></li>
								</ul>
									...
									<div class="reviewInfo">
										...
										<div class="comment">
											...
											<div class="textArea">
												...
												<p><%= FormatDate(EvList.FItemList(i).FRegDate, "0000/00/00") %></p>
											</div>
											...
											<% end if %>
											<div class="btnArea">
												<a href="javascript:AddEval('<%= EvList.FItemList(i).FOrderSerial %>','<%= EvList.FItemList(i).FItemID %>','<%= EvList.FItemList(i).FItemOption %>');" title="상품 후기 수정하기" class="btn btnS2 btnGry2"><span class="fn">수정</span></a>
									...
									<li>
										<div class="pdtBox">
											...
											<div class="cartBtn">
												...
												%>
												<a href="" onclick="AddEval('<%= EvList.FItemList(i).FOrderSerial %>','<%= EvList.FItemList(i).FItemID %>','<%= EvList.FItemList(i).FItemOption %>'); fnAmplitudeEventMultiPropertiesAction('click_my_review_write','firstreview|productname|brandname|mileage','<%=vAmplitudeFirstReview%>|<%=EvList.FItemList(i).FItemname%>|<%=EvList.FItemList(i).FMakerName%>|<%=vAmplitudeMileage%>'); return false;" class="btn btnM2 btnWhite btnW150">상품후기</a>												
												<% if EvList.FItemList(i).FEvalCnt=0 then %>
