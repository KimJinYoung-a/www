...
dim userid,orderserial,itemid,ItemOption,EvaluatedYN,cdL,userlevel
		...
		<div class="popWrap">
			...
			<div class="popContent">
				...
				<div class="mySection">
					...
					<form name="FrmGoodusing" method="post" action="<%=staticImgUpUrl%>/linkweb/doevaluatewithimage_utf8.asp?gaparam=<%=gaparam%>" EncType="multipart/form-data">
