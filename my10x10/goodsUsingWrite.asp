    ...
    if (confirm("입력사항이 정확합니까?") == true) {
            ...
            if(typeof qg !== "undefined"){
                let appier_review_submitted_data = {
                    "review_rating" : parseInt($("input[name=totPnt]:checked").val())
                    , "category_code" : "<%= EvList.FEvalItem.Fcatecode %>"
                    , "category_name_depth1" : "<%= EvList.FEvalItem.Ffirst_depth_cate %>"
                    , "category_name_depth2" : "<%= EvList.FEvalItem.Fsecond_depth_cate %>"
                    , "brand_name" : "<%= EvList.FEvalItem.FMakerName %>"
                    , "brand_id" : "<%=EvList.FEvalItem.FMakerID%>"
                    , "product_id" : "<%=EvList.FEvalItem.FItemID%>"
                    , "product_name" : "<%=replace(EvList.FEvalItem.FItemname,"""","")%>"
...
<body>
	<div class="heightgird">
		...
		<div class="popWrap">
			<div class="popHeader">
				<h1><img src="http://fiximage.10x10.co.kr/web2013/my10x10/tit_product_review_write.gif" alt="상품후기 쓰기" /></h1>
			</div>
				...
				<div class="mySection">
					...
					<fieldset>
						...
						<tr>
							...
							<td>
								<div class="goodsInfo">
									<div class="pdtPhoto"><img src="<%= EvList.FEvalItem.FIcon2 %>" width="150" height="150" alt="<%=replace(EvList.FEvalItem.FItemname,"""","")%>" /></div>
									<div class="pdfInfo">
						...
						%>
							...
							.healthNoti p {text-align:center; font-size:11px; margin:30px 0 25px; padding-top:40px; background:url(http://fiximage.10x10.co.kr/web2013/common/ico_warning02.png) center top no-repeat;}
							</style>
							<tr>
								...
								<div class="satisfactionList">
									<div class="itemField">
										...
										<ul>
											...
											<li><input type="radio" name="totPnt" onclick="fnAmplitudeEventMultiPropertiesAction('click_my_review_star','star|type','2|overall');" type="radio" value="2" <% if EvList.FEvalItem.FTotalPoint="2" then response.write "checked" %> id="satisfaction13" /> <label for="satisfaction13"><img src="//fiximage.10x10.co.kr/web2019/common/ico_review_star_02.png" alt="별2개" /></label></li>
