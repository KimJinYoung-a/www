...
<% If (cPopular.FResultCount > 0) Then %>
	...
	<% Else %>
			...
			<div class="box">
				...
				<div class="info" onClick="window.open('/shopping/category_prd.asp?itemid=<%= cPopular.FItemList(i).FItemID %>','','width=1200,height=800,toolbar=yes, location=yes, directories=yes, status=yes, menubar=yes, scrollbars=yes, copyhistory=yes, resizable=yes');">
