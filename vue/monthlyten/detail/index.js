...
<div class="univarsal" id="content">
    <div class="visual-area">
        <div class="visual-bnr bnr01"><img src="//webimage.10x10.co.kr/fixevent/event/2022/ten_sale12/top-banner.jpg" alt="선물하기 좋은"></div>
    </div>
    ...
    , created() {
        ...
        this.$store.dispatch("GET_ATTRIBUTE_GROUP").then(function() {
            ...
            new Swiper(".item-swiper .swiper-container", {
                slidesPerView:'auto',
                speed:500,
            });
        });
    ...
    , watch: {
      swiper_check(value) {
          if (!value) {
              ...
              swiperInfo.slideTo(this.swiper_index);
          }
      }
  }
});