const app = new Vue({
  ...
  <div class="evt118248">
            <section class="section01">
              <div class="float">
                <img src="//webimage.10x10.co.kr/fixevent/event/2022/120001/float01.png" class="float01" alt="">
                <img src="//webimage.10x10.co.kr/fixevent/event/2022/120001/float02.png" class="float02" alt="">
              </div>
            </section>
            ...
            <section class="section03">
               <div class="section03_01 sect_group">
                <a href="#mapGroup412159" class="group_link"></a>
              </div>
              <div class="section03_02 sect_item">
                <ul id="lyrItemlist" class="item_list">
                  <li class="item4466408">
                    <a href="/shopping/category_prd.asp?itemid=4466408">
                  ...
                  <li class="item4743752">
                    <a href="/shopping/category_prd.asp?itemid=4743752">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
                  ...
                  <li class="item4483164">
                    <a href="/shopping/category_prd.asp?itemid=4483164">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
                  ...
                  <li class="item4843661">
                    <a href="/shopping/category_prd.asp?itemid=4843661">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
            ...
            <section class="section04">
               <div class="section04_01 sect_group">
                <a href="#mapGroup412160" class="group_link"></a>
              </div>
              <div class="section04_02 sect_item">
                <ul id="lyrItemlist" class="item_list">
                  <li class="item4707171">
                    <a href="/shopping/category_prd.asp?itemid=4707171">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
                  ...
                  <li class="item4754968">
                    <a href="/shopping/category_prd.asp?itemid=4754968">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
                  ...
                  <li class="item4175803">
                    <a href="/shopping/category_prd.asp?itemid=4175803">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
                  ...
                  <li class="item4755487">
                    <a href="/shopping/category_prd.asp?itemid=4755487">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
            ...
            <section class="section05">
               <div class="section05_01 sect_group">
                <a href="#mapGroup412161" class="group_link"></a>
              </div>
              <div class="section05_02 sect_item">
                <ul id="lyrItemlist" class="item_list">
                  <li class="item4595044">
                    <a href="/shopping/category_prd.asp?itemid=4595044">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
                  ...
                  <li class="item4804880">
                    <a href="/shopping/category_prd.asp?itemid=4804880">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
                  ...
                  <li class="item4805757">
                    <a href="/shopping/category_prd.asp?itemid=4805757">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
                  ...
                  <li class="item4771803">
                    <a href="/shopping/category_prd.asp?itemid=4771803">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
            ...
            <section class="section06">
               <div class="section06_01 sect_group">
                <a href="#mapGroup412162" class="group_link"></a>
              </div>
              <div class="section06_02 sect_item">
                <ul id="lyrItemlist" class="item_list">
                  <li class="item4825573">
                    <a href="/shopping/category_prd.asp?itemid=4825573">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
                  ...
                  <li class="item4772002">
                    <a href="/shopping/category_prd.asp?itemid=4772002">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
                  ...
                  <li class="item3818406">
                    <a href="/shopping/category_prd.asp?itemid=3818406">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
                  ...
                  <li class="item3624616">
                    <a href="/shopping/category_prd.asp?itemid=3624616">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
...
<!--                        <span><b>12.7</b> 화요일</span> 제품 미리보기-->
  ...
  data: function () {
      return {
          ...
          timeDealItems : [
              {itemid: '4854723', openDate: '20220906'},
              {itemid: '4857223', openDate: '20220907'},
              {itemid: '4857805', openDate: '20220908'},
              {itemid: '4851594', openDate: '20220909'},
              {itemid: '4851692', openDate: '20220910'},
              {itemid: '4857356', openDate: '20220911'},
              {itemid: '4857149', openDate: '20220912'}
          ],
          todayTimeDeal: {},
          itemDetail: {},
          dealItemDetails: []
  ...
  created() {
      ...
      fnApplyItemInfoEach({
          items:"4466408,4743752,4483164,4843661",
          target:"item",
      ...
      fnApplyItemInfoEach({
          items:"4707171,4754968,4175803,4755487",
          target:"item",
          fields:["price","sale","name","image","brand"],
          unit:"none",
          saleBracket:false
      ...
      fnApplyItemInfoEach({
          items:"4595044,4804880,4805757,4771803",
          target:"item",
          fields:["price","sale","name","image","brand"],
          unit:"none",
          saleBracket:false
      ...
      fnApplyItemInfoEach({
          items:"4825573,4772002,3818406,3624616",
          target:"item",
          fields:["price","sale","name","image","brand"],
          unit:"none",
          saleBracket:false
