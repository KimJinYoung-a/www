const app = new Vue({
    ...
    <div class="evt118248">
              <section class="section01">
                <div class="float">
                  <img src="//webimage.10x10.co.kr/fixevent/event/2022/119017/float01.png" class="float01" alt="">
                  <img src="//webimage.10x10.co.kr/fixevent/event/2022/119017/float02.png" class="float02" alt="">
                </div>
              </section>
              ...
              <section class="section03">
                 <div class="section03_01 sect_group">
                  <a href="#mapGroup406432" class="group_link"></a>
                </div>
                <div class="section03_02 sect_item">
                  <ul id="lyrItemlist" class="item_list">
                    <li class="item4610948">
                      <a href="/shopping/category_prd.asp?itemid=4610948">
                    ...
                    <li class="item4374655">
                      <a href="/shopping/category_prd.asp?itemid=4374655">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
                    ...
                    <li class="item3958139">
                      <a href="/shopping/category_prd.asp?itemid=3958139">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
                    ...
                    <li class="item4587193">
                      <a href="/shopping/category_prd.asp?itemid=4587193">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
              ...
              <section class="section04">
                 <div class="section04_01 sect_group">
                  <a href="#mapGroup407219" class="group_link"></a>
                </div>
                <div class="section04_02 sect_item">
                  <ul id="lyrItemlist" class="item_list">
                    <li class="item4640226">
                      <a href="/shopping/category_prd.asp?itemid=4640226">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
                    ...
                    <li class="item3963704">
                      <a href="/shopping/category_prd.asp?itemid=3963704">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
                    ...
                    <li class="item4540227">
                      <a href="/shopping/category_prd.asp?itemid=4540227">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
                    ...
                    <li class="item4283111">
                      <a href="/shopping/category_prd.asp?itemid=4283111">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
              ...
              <section class="section05">
                 <div class="section05_01 sect_group">
                  <a href="#mapGroup407220" class="group_link"></a>
                </div>
                <div class="section05_02 sect_item">
                  <ul id="lyrItemlist" class="item_list">
                    <li class="item4174279">
                      <a href="/shopping/category_prd.asp?itemid=4174279">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
                    ...
                    <li class="item3668316">
                      <a href="/shopping/category_prd.asp?itemid=3668316">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
                    ...
                    <li class="item4422341">
                      <a href="/shopping/category_prd.asp?itemid=4422341">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
                    ...
                    <li class="item4489829">
                      <a href="/shopping/category_prd.asp?itemid=4489829">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
              ...
              <section class="section06">
                 <div class="section06_01 sect_group">
                  <a href="#mapGroup407221" class="group_link"></a>
                </div>
                <div class="section06_02 sect_item">
                  <ul id="lyrItemlist" class="item_list">
                    ...
                    <li class="item4529727">
                      <a href="/shopping/category_prd.asp?itemid=4529727">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
                    ...
                    <li class="item4691636">
                      <a href="/shopping/category_prd.asp?itemid=4691636">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
                    ...
                    <li class="item4651149">
                      <a href="/shopping/category_prd.asp?itemid=4651149">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
...
<!--                        <span><b>12.7</b> 화요일</span> 제품 미리보기-->
    ...
    data: function () {
        return {
            ...
            timeDealItems : [
                {itemid: '4723628', openDate: '20220628'},
                {itemid: '4723627', openDate: '20220629'},
                {itemid: '4723629', openDate: '20220630'},
                {itemid: '4723631', openDate: '20220701'},
                {itemid: '4723656', openDate: '20220702'},
                {itemid: '4723657', openDate: '20220703'},
                {itemid: '4723658', openDate: '20220704'}
            ],
            todayTimeDeal: {},
            itemDetail: {},
            dealItemDetails: []
    ...
    created() {
        ...
        fnApplyItemInfoEach({
            items:"4610948,4374655,3958139,4587193",
            target:"item",
        ...
        fnApplyItemInfoEach({
            items:"4640226,3963704,4540227,4283111",
            target:"item",
            fields:["price","sale","name","image","brand"],
            unit:"none",
            saleBracket:false
        ...
        fnApplyItemInfoEach({
            items:"4174279,3668316,4422341,4489829",
            target:"item",
            fields:["price","sale","name","image","brand"],
            unit:"none",
            saleBracket:false
        ...
        fnApplyItemInfoEach({
            items:"4641132,4529727,4691636,4651149",
            target:"item",
            fields:["price","sale","name","image","brand"],
            unit:"none",
            saleBracket:false
