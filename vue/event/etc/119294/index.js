const app = new Vue({
  ...
  <div class="evt118248">
            <section class="section01">
              <div class="float">
                <img src="//webimage.10x10.co.kr/fixevent/event/2022/119294/float01.png" class="float01" alt="">
                <img src="//webimage.10x10.co.kr/fixevent/event/2022/119294/float02.png" class="float02" alt="">
              </div>
            </section>
            ...
            <section class="section03">
               <div class="section03_01 sect_group">
                <a href="#mapGroup408574" class="group_link"></a>
              </div>
              <div class="section03_02 sect_item">
                <ul id="lyrItemlist" class="item_list">
                  <li class="item4649842">
                    <a href="/shopping/category_prd.asp?itemid=4649842">
                  ...
                  <li class="item4629962">
                    <a href="/shopping/category_prd.asp?itemid=4629962">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
                  ...
                  <li class="item4756890">
                    <a href="/shopping/category_prd.asp?itemid=4756890">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
                  ...
                  <li class="item4641132">
                    <a href="/shopping/category_prd.asp?itemid=4641132">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
            ...
            <section class="section04">
               <div class="section04_01 sect_group">
                <a href="#mapGroup408575" class="group_link"></a>
              </div>
              <div class="section04_02 sect_item">
                <ul id="lyrItemlist" class="item_list">
                  <li class="item4754865">
                    <a href="/shopping/category_prd.asp?itemid=4754865">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
                  ...
                  <li class="item4700443">
                    <a href="/shopping/category_prd.asp?itemid=4700443">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
                  ...
                  <li class="item4754967">
                    <a href="/shopping/category_prd.asp?itemid=4754967">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
                  ...
                  <li class="item3881350">
                    <a href="/shopping/category_prd.asp?itemid=3881350">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
            ...
            <section class="section05">
               <div class="section05_01 sect_group">
                <a href="#mapGroup408577" class="group_link"></a>
              </div>
              <div class="section05_02 sect_item">
                <ul id="lyrItemlist" class="item_list">
                  <li class="item3699300">
                    <a href="/shopping/category_prd.asp?itemid=3699300">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
                  ...
                  <li class="item4626021">
                    <a href="/shopping/category_prd.asp?itemid=4626021">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
                  ...
                  <li class="item4747664">
                    <a href="/shopping/category_prd.asp?itemid=4747664">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
                  ...
                  <li class="item4531115">
                    <a href="/shopping/category_prd.asp?itemid=4531115">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
            ...
            <section class="section06">
               <div class="section06_01 sect_group">
                <a href="#mapGroup408576" class="group_link"></a>
              </div>
              <div class="section06_02 sect_item">
                <ul id="lyrItemlist" class="item_list">
                  <li class="item4746661">
                    <a href="/shopping/category_prd.asp?itemid=4746661">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
                  ...
                  <li class="item4691418">
                    <a href="/shopping/category_prd.asp?itemid=4691418">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
                  ...
                  <li class="item3807919">
                    <a href="/shopping/category_prd.asp?itemid=3807919">
                      <div class="thumbnail"><img src="" alt=""></div>
                      <div class="desc">
                        <p class="brand">브랜드명</p>
                        <p class="name">상품명상품명상품명상품명상품명상품명</p>
...
<!--                        <span><b>12.7</b> 화요일</span> 제품 미리보기-->
  ...
  data: function () {
      return {
          ...
          timeDealItems : [
              {itemid: '4757206', openDate: '20220718'},
              {itemid: '4756742', openDate: '20220719'},
              {itemid: '4754982', openDate: '20220720'},
              {itemid: '4758420', openDate: '20220721'},
              {itemid: '4758422', openDate: '20220722'},
              {itemid: '4757131', openDate: '20220723'},
              {itemid: '4754976', openDate: '20220724'}
          ],
          todayTimeDeal: {},
          itemDetail: {},
          dealItemDetails: []
  ...
  created() {
      ...
      fnApplyItemInfoEach({
          items:"4649842,4629962,4756890,4641132",
          target:"item",
      ...
      fnApplyItemInfoEach({
          items:"4754865,4700443,4754967,3881350",
          target:"item",
          fields:["price","sale","name","image","brand"],
          unit:"none",
          saleBracket:false
      ...
      fnApplyItemInfoEach({
          items:"3699300,4626021,4747664,4531115",
          target:"item",
          fields:["price","sale","name","image","brand"],
          unit:"none",
          saleBracket:false
      ...
      fnApplyItemInfoEach({
          items:"4746661,4691418,3807919,3854716",
          target:"item",
          fields:["price","sale","name","image","brand"],
          unit:"none",
          saleBracket:false
