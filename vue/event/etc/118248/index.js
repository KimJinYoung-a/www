const app = new Vue({
    ...
    <div class="evt118248">
              <section class="section01">
                <div class="float">
                  <img src="//webimage.10x10.co.kr/fixevent/event/2022/118248/float01.png" class="float01" alt="">
                  <img src="//webimage.10x10.co.kr/fixevent/event/2022/118248/float02.png" class="float02" alt="">
                </div>
              </section>
              ...
              <section class="section03">
                 <div class="section03_01 sect_group">
                  <a href="#mapGroup403313" class="group_link"></a>
                </div>
                <div class="section03_02 sect_item">
                  <ul id="lyrItemlist" class="item_list">
                    <li class="item4547630">
                      <a href="/shopping/category_prd.asp?itemid=4547630">
                    ...
                    <li class="item4397065">
                      <a href="/shopping/category_prd.asp?itemid=4397065">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
                    ...
                    <li class="item4129523">
                      <a href="/shopping/category_prd.asp?itemid=4129523">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
                    ...
                    <li class="item4587195">
                      <a href="/shopping/category_prd.asp?itemid=4587195">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
              ...
              <section class="section04">
                 <div class="section04_01 sect_group">
                  <a href="#mapGroup403314" class="group_link"></a>
                </div>
                <div class="section04_02 sect_item">
                  <ul id="lyrItemlist" class="item_list">
                    <li class="item4103476">
                      <a href="/shopping/category_prd.asp?itemid=4103476">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
                    ...
                    <li class="item4271740">
                      <a href="/shopping/category_prd.asp?itemid=4271740">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
                    ...
                    <li class="item4217900">
                      <a href="/shopping/category_prd.asp?itemid=4217900">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
                    ...
                    <li class="item3605366">
                      <a href="/shopping/category_prd.asp?itemid=3605366">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
              ...
              <section class="section05">
                 <div class="section05_01 sect_group">
                  <a href="#mapGroup403315" class="group_link"></a>
                </div>
                <div class="section05_02 sect_item">
                  <ul id="lyrItemlist" class="item_list">
                    <li class="item3680467">
                      <a href="/shopping/category_prd.asp?itemid=3680467">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
                    ...
                    <li class="item3515587">
                      <a href="/shopping/category_prd.asp?itemid=3515587">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
                    ...
                    <li class="item3854716">
                      <a href="/shopping/category_prd.asp?itemid=3854716">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
                    ...
                    <li class="item3302163">
                      <a href="/shopping/category_prd.asp?itemid=3302163">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
              ...
              <section class="section06">
                 <div class="section06_01 sect_group">
                  <a href="#mapGroup403316" class="group_link"></a>
                </div>
                <div class="section06_02 sect_item">
                  <ul id="lyrItemlist" class="item_list">
                    <li class="item4419706">
                      <a href="/shopping/category_prd.asp?itemid=4419706">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
                    ...
                    <li class="item4324487">
                      <a href="/shopping/category_prd.asp?itemid=4324487">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
                    ...
                    <li class="item3984416">
                      <a href="/shopping/category_prd.asp?itemid=3984416">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
                    ...
                    <li class="item3897824">
                      <a href="/shopping/category_prd.asp?itemid=3897824">
                        <div class="thumbnail"><img src="" alt=""></div>
                        <div class="desc">
                          <p class="brand">브랜드명</p>
                          <p class="name">상품명상품명상품명상품명상품명상품명</p>
...
<!--                        <span><b>12.7</b> 화요일</span> 제품 미리보기-->
    ...
    data: function () {
        return {
            ...
            timeDealItems : [
                {itemid: '4593389', openDate: '20220516'},
                {itemid: '4593356', openDate: '20220517'},
                {itemid: '4593543', openDate: '20220518'},
                {itemid: '4593310', openDate: '20220519'},
                {itemid: '4593387', openDate: '20220520'},
                {itemid: '4590586', openDate: '20220521'},
                {itemid: '4598936', openDate: '20220522'}
            ],
            todayTimeDeal: {},
            itemDetail: {},
            dealItemDetails: []
    ...
    created() {
        ...
        fnApplyItemInfoEach({
            items:"4547630,4397065,4129523,4587195",
            target:"item",
        ...
        fnApplyItemInfoEach({
            items:"4103476,4271740,4217900,3605366",
            target:"item",
            fields:["price","sale","name","image","brand"],
            unit:"none",
            saleBracket:false
        ...
        fnApplyItemInfoEach({
            items:"3680467,3515587,3854716,3302163",
            target:"item",
            fields:["price","sale","name","image","brand"],
            unit:"none",
            saleBracket:false
        ...
        fnApplyItemInfoEach({
            items:"4419706,4324487,3984416,3897824",
            target:"item",
            fields:["price","sale","name","image","brand"],
            unit:"none",
            saleBracket:false
