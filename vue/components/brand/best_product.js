Vue.component('BEST-PRODUCT', {
    template : `
        <li :class="product_li_class">
            <div class="pdtNumV15"><img :src="'http://fiximage.10x10.co.kr/web2015/brand/txt_best_num0' + (index+1) + '.png'" alt="1"></div>
            <div class="pdtBox">
                <i v-if="product.free_delivery_yn" class="free-shipping-badge">무료<br>배송</i>
                ...
                <PRODUCT-ACTION
                    :item_id="product.item_id"
                    :review_count="product.review_cnt"
                    :wish_count="product.wish_cnt"
                ></PRODUCT-ACTION>
            </div>
        </li>
    `,
