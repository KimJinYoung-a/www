		...
		For i = 0 To PrdBrandList.FResultCount - 1
			...
			if PrdBrandList.FItemList(i).IsSaleItem or PrdBrandList.FItemList(i).isCouponItem Then
				IF PrdBrandList.FItemList(i).IsSaleItem then
					oJson("diarylist")(null)("price") = "<p class='price'>"&FormatNumber(PrdBrandList.FItemList(i).getRealPrice,0)&"원"&"<strong class='cRd0V15'>["&PrdBrandList.FItemList(i).getSalePro&"]</strong></p>"
				elseif PrdBrandList.FItemList(i).IsCouponItem Then
					oJson("diarylist")(null)("price") = "<p class='price'>"&FormatNumber(PrdBrandList.FItemList(i).GetCouponAssignPrice,0)&"원"&"<strong class='cGr0V15'>["&PrdBrandList.FItemList(i).GetCouponDiscountStr&"]</strong></p>"
				elseif PrdBrandList.FItemList(i).IsSaleItem and PrdBrandList.FItemList(i).isCouponItem then
					oJson("diarylist")(null)("price") = "<p class='price'>"&FormatNumber(PrdBrandList.FItemList(i).getRealPrice,0)&"원"&"<strong class='cRd0V15'>["&PrdBrandList.FItemList(i).getSalePro&"]</strong></p><p class='price'>"&FormatNumber(PrdBrandList.FItemList(i).GetCouponAssignPrice,0)&"원"&"<strong class='cGr0V15'>["&PrdBrandList.FItemList(i).GetCouponDiscountStr&"]</strong></p>"
				end if
			else
				oJson("diarylist")(null)("price") = "<p class='price'>"&FormatNumber(PrdBrandList.FItemList(i).getRealPrice,0)&chkIIF(PrdBrandList.FItemList(i).IsMileShopitem,"Point","원")&"</p>"
			end if
		next
